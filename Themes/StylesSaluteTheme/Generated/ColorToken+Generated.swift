...
public extension ColorToken {
    ...
    static var backgroundDefaultPrimary: Self {
        Self(
            ...
            lightColor: Color(UIColor(hex: "#F2F2F2FF"))
        )
    }
    static var backgroundDefaultPrimaryBrightness: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F0FFFFF")),
            lightColor: Color(UIColor(hex: "#F3F3F3FF"))
        )
    }
    ...
    static var backgroundInversePrimary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F2F2FF")),
    ...
    static var outlineDefaultAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var outlineDefaultAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E8ADDFF")),
            lightColor: Color(UIColor(hex: "#0E75B9FF"))
        )
    }
    static var outlineDefaultAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#66BCF5FF")),
            lightColor: Color(UIColor(hex: "#2AA0EFFF"))
        )
    }
    static var outlineDefaultAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0D5382")),
            lightColor: Color(UIColor(hex: "#52BAFF"))
        )
    }
    static var outlineDefaultAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10659EFF")),
            lightColor: Color(UIColor(hex: "#29A9FFFF"))
        )
    }
    static var outlineDefaultAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1277BAFF")),
            lightColor: Color(UIColor(hex: "#7ACAFFFF"))
        )
    }
    static var outlineDefaultAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var outlineDefaultAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var outlineDefaultAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var outlineDefaultAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var outlineDefaultAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var outlineDefaultAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    }
    static var outlineDefaultAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var outlineDefaultAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#337AFFFF")),
            lightColor: Color(UIColor(hex: "#1767FDFF"))
        )
    }
    static var outlineDefaultAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3C3FFFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var outlineDefaultAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1549AB")),
            lightColor: Color(UIColor(hex: "#8BB2FC"))
        )
    }
    static var outlineDefaultAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1C62E3FF")),
            lightColor: Color(UIColor(hex: "#6599FBFF"))
        )
    }
    static var outlineDefaultAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#B4CEFDFF"))
        )
    }
    ...
    static var outlineDefaultAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var outlineDefaultAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B84DFFFF")),
            lightColor: Color(UIColor(hex: "#A432F1FF"))
        )
    }
    static var outlineDefaultAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E4BDFFFF")),
            lightColor: Color(UIColor(hex: "#C67EF6FF"))
        )
    }
    static var outlineDefaultAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#722BA1")),
            lightColor: Color(UIColor(hex: "#D39CF7"))
        )
    }
    static var outlineDefaultAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8933C1FF")),
            lightColor: Color(UIColor(hex: "#C276F4FF"))
        )
    }
    static var outlineDefaultAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#E3C2FAFF"))
        )
    }
    static var outlineDefaultAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var outlineDefaultAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var outlineDefaultAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var outlineDefaultAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var outlineDefaultAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var outlineDefaultAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    ...
    static var outlineDefaultTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF047")),
            lightColor: Color(UIColor(hex: "#118CDF33"))
        )
    }
    static var outlineDefaultTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF056")),
            lightColor: Color(UIColor(hex: "#118CDF3D"))
        )
    }
    static var outlineDefaultTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0FF")),
            lightColor: Color(UIColor(hex: "#118CDFFF"))
        )
    }
    static var outlineDefaultTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E47")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var outlineDefaultTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E56")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var outlineDefaultTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23EFF")),
            lightColor: Color(UIColor(hex: "#1A9E32FF"))
        )
    }
    static var outlineDefaultTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF47")),
            lightColor: Color(UIColor(hex: "#3F81FD33"))
        )
    }
    static var outlineDefaultTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF56")),
            lightColor: Color(UIColor(hex: "#3F82FD3D"))
        )
    }
    static var outlineDefaultTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFFFF")),
            lightColor: Color(UIColor(hex: "#3F82FDFF"))
        )
    }
    ...
    static var outlineDefaultTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF47")),
            lightColor: Color(UIColor(hex: "#B559F333"))
        )
    }
    static var outlineDefaultTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF56")),
            lightColor: Color(UIColor(hex: "#B558F33D"))
        )
    }
    static var outlineDefaultTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFFFF")),
            lightColor: Color(UIColor(hex: "#B558F3FF"))
        )
    }
    static var outlineDefaultTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E47")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var outlineDefaultTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E56")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var outlineDefaultTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23EFF")),
            lightColor: Color(UIColor(hex: "#1A9E32FF"))
        )
    ...
    static var outlineDefaultTransparentPrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF25")),
            lightColor: Color(UIColor(hex: "#0808083D"))
        )
    }
    static var outlineDefaultTransparentPrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#080808FF"))
        )
    }
    static var outlineDefaultTransparentSecondary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF33")),
            lightColor: Color(UIColor(hex: "#08080866"))
        )
    }
    ...
    static var outlineDefaultTransparentTertiaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF7A")),
            lightColor: Color(UIColor(hex: "#080808AB"))
        )
    }
    ...
    static var outlineInverseAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#199AF0"))
        )
    }
    static var outlineInverseAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F7BC2FF")),
            lightColor: Color(UIColor(hex: "#0D84D3FF"))
        )
    }
    static var outlineInverseAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#50B1F2FF")),
            lightColor: Color(UIColor(hex: "#3FABF3FF"))
        )
    }
    static var outlineInverseAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#52BAFF")),
            lightColor: Color(UIColor(hex: "#0D5382"))
        )
    }
    static var outlineInverseAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#33ADFFFF")),
            lightColor: Color(UIColor(hex: "#116BA7FF"))
        )
    }
    static var outlineInverseAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3DAFFFF")),
            lightColor: Color(UIColor(hex: "#1483CCFF"))
        )
    }
    static var outlineInverseAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var outlineInverseAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var outlineInverseAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var outlineInverseAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var outlineInverseAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var outlineInverseAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    }
    static var outlineInverseAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#199AF0"))
        )
    }
    static var outlineInverseAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F7BC2FF")),
            lightColor: Color(UIColor(hex: "#0D84D3FF"))
        )
    }
    static var outlineInverseAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#50B1F2FF")),
            lightColor: Color(UIColor(hex: "#3FABF3FF"))
        )
    }
    static var outlineInverseAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8BB2FC")),
            lightColor: Color(UIColor(hex: "#1549AB"))
        )
    }
    static var outlineInverseAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#6FA0FBFF")),
            lightColor: Color(UIColor(hex: "#113B88FF"))
        )
    }
    static var outlineInverseAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DCE8FEFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    }
    ...
    static var outlineInverseAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#C46BFF"))
        )
    }
    static var outlineInverseAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A93BF1FF")),
            lightColor: Color(UIColor(hex: "#B442FFFF"))
        )
    }
    static var outlineInverseAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D7A4F9FF")),
            lightColor: Color(UIColor(hex: "#D494FFFF"))
        )
    }
    static var outlineInverseAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D39CF7")),
            lightColor: Color(UIColor(hex: "#722BA1"))
        )
    }
    static var outlineInverseAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C680F5FF")),
            lightColor: Color(UIColor(hex: "#5B2281FF"))
        )
    }
    static var outlineInverseAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E7FDFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    }
    static var outlineInverseAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var outlineInverseAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var outlineInverseAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var outlineInverseAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var outlineInverseAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var outlineInverseAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    ...
    static var outlineInverseTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF33")),
            lightColor: Color(UIColor(hex: "#199AF047"))
        )
    }
    static var outlineInverseTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF3D")),
            lightColor: Color(UIColor(hex: "#199AF056"))
        )
    }
    static var outlineInverseTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDFFF")),
            lightColor: Color(UIColor(hex: "#199AF0FF"))
        )
    }
    static var outlineInverseTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#24B23E47"))
        )
    }
    static var outlineInverseTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#24B23E56"))
        )
    }
    static var outlineInverseTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32FF")),
            lightColor: Color(UIColor(hex: "#24B23EFF"))
        )
    }
    static var outlineInverseTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD33")),
            lightColor: Color(UIColor(hex: "#528EFF47"))
        )
    }
    static var outlineInverseTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD3D")),
            lightColor: Color(UIColor(hex: "#528EFF56"))
        )
    }
    static var outlineInverseTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FDFF")),
            lightColor: Color(UIColor(hex: "#528EFFFF"))
        )
    }
    ...
    static var outlineInverseTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F333")),
            lightColor: Color(UIColor(hex: "#C46BFF47"))
        )
    }
    static var outlineInverseTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F33D")),
            lightColor: Color(UIColor(hex: "#C46BFF56"))
        )
    }
    static var outlineInverseTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F3FF")),
            lightColor: Color(UIColor(hex: "#C46BFFFF"))
        )
    }
    static var outlineInverseTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#24B23E47"))
        )
    }
    static var outlineInverseTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#24B23E56"))
        )
    }
    static var outlineInverseTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32FF")),
            lightColor: Color(UIColor(hex: "#24B23EFF"))
        )
    ...
    static var outlineInverseTransparentPrimaryActive: Self {
        Self(
            ...
            lightColor: Color(UIColor(hex: "#FFFFFF25"))
        )
    }
    static var outlineInverseTransparentPrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808FF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    ...
    static var outlineInverseTransparentSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0808087A")),
    ...
    static var outlineInverseTransparentTertiary: Self {
        Self(
            ...
            lightColor: Color(UIColor(hex: "#FFFFFF66"))
        )
    }
    static var outlineInverseTransparentTertiaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808AB")),
    ...
    static var outlineOnDarkAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0")),
            lightColor: Color(UIColor(hex: "#199AF0"))
        )
    }
    static var outlineOnDarkAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E8ADDFF")),
            lightColor: Color(UIColor(hex: "#0D84D3FF"))
        )
    }
    static var outlineOnDarkAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#66BCF5FF")),
            lightColor: Color(UIColor(hex: "#3FABF3FF"))
        )
    }
    static var outlineOnDarkAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0D5382")),
            lightColor: Color(UIColor(hex: "#0D5382"))
        )
    }
    static var outlineOnDarkAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10659EFF")),
            lightColor: Color(UIColor(hex: "#116BA7FF"))
        )
    }
    static var outlineOnDarkAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1277BAFF")),
            lightColor: Color(UIColor(hex: "#1483CCFF"))
        )
    }
    static var outlineOnDarkAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var outlineOnDarkAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var outlineOnDarkAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var outlineOnDarkAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var outlineOnDarkAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var outlineOnDarkAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    }
    static var outlineOnDarkAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF")),
            lightColor: Color(UIColor(hex: "#528EFF"))
        )
    }
    static var outlineOnDarkAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#337AFFFF")),
            lightColor: Color(UIColor(hex: "#2974FFFF"))
        )
    }
    static var outlineOnDarkAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3C3FFFF")),
            lightColor: Color(UIColor(hex: "#7AA9FFFF"))
        )
    }
    static var outlineOnDarkAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1549AB")),
            lightColor: Color(UIColor(hex: "#1549AB"))
        )
    }
    static var outlineOnDarkAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1C62E3FF")),
            lightColor: Color(UIColor(hex: "#113B88FF"))
        )
    }
    static var outlineOnDarkAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    ...
    static var outlineOnDarkAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF")),
            lightColor: Color(UIColor(hex: "#C46BFF"))
        )
    }
    static var outlineOnDarkAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B84DFFFF")),
            lightColor: Color(UIColor(hex: "#B442FFFF"))
        )
    }
    static var outlineOnDarkAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E4BDFFFF")),
            lightColor: Color(UIColor(hex: "#D494FFFF"))
        )
    }
    static var outlineOnDarkAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#722BA1")),
            lightColor: Color(UIColor(hex: "#722BA1"))
        )
    }
    static var outlineOnDarkAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8933C1FF")),
            lightColor: Color(UIColor(hex: "#5B2281FF"))
        )
    }
    static var outlineOnDarkAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    }
    static var outlineOnDarkAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var outlineOnDarkAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var outlineOnDarkAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var outlineOnDarkAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var outlineOnDarkAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var outlineOnDarkAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    ...
    static var outlineOnDarkTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF047")),
            lightColor: Color(UIColor(hex: "#199AF047"))
        )
    }
    static var outlineOnDarkTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF056")),
            lightColor: Color(UIColor(hex: "#199AF056"))
        )
    }
    static var outlineOnDarkTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0FF")),
            lightColor: Color(UIColor(hex: "#199AF0FF"))
        )
    }
    static var outlineOnDarkTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E47")),
            lightColor: Color(UIColor(hex: "#24B23E47"))
        )
    }
    static var outlineOnDarkTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E56")),
            lightColor: Color(UIColor(hex: "#24B23E56"))
        )
    }
    static var outlineOnDarkTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23EFF")),
            lightColor: Color(UIColor(hex: "#24B23EFF"))
        )
    }
    static var outlineOnDarkTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF47")),
            lightColor: Color(UIColor(hex: "#528EFF47"))
        )
    }
    static var outlineOnDarkTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF56")),
            lightColor: Color(UIColor(hex: "#528EFF56"))
        )
    }
    static var outlineOnDarkTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFFFF")),
            lightColor: Color(UIColor(hex: "#528EFFFF"))
        )
    ...
    static var outlineOnDarkTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF47")),
            lightColor: Color(UIColor(hex: "#C46BFF47"))
        )
    }
    static var outlineOnDarkTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF56")),
            lightColor: Color(UIColor(hex: "#C46BFF56"))
        )
    }
    static var outlineOnDarkTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFFFF")),
            lightColor: Color(UIColor(hex: "#C46BFFFF"))
        )
    }
    static var outlineOnDarkTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E47")),
            lightColor: Color(UIColor(hex: "#24B23E47"))
        )
    }
    static var outlineOnDarkTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E56")),
            lightColor: Color(UIColor(hex: "#24B23E56"))
        )
    }
    static var outlineOnDarkTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23EFF")),
            lightColor: Color(UIColor(hex: "#24B23EFF"))
        )
    ...
    static var outlineOnLightAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var outlineOnLightAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F7BC2FF")),
            lightColor: Color(UIColor(hex: "#0E75B9FF"))
        )
    }
    static var outlineOnLightAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#50B1F2FF")),
            lightColor: Color(UIColor(hex: "#2AA0EFFF"))
        )
    }
    static var outlineOnLightAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#52BAFF")),
            lightColor: Color(UIColor(hex: "#52BAFF"))
        )
    }
    static var outlineOnLightAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#33ADFFFF")),
            lightColor: Color(UIColor(hex: "#29A9FFFF"))
        )
    }
    static var outlineOnLightAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3DAFFFF")),
            lightColor: Color(UIColor(hex: "#7ACAFFFF"))
        )
    }
    static var outlineOnLightAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var outlineOnLightAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var outlineOnLightAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var outlineOnLightAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var outlineOnLightAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var outlineOnLightAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    }
    static var outlineOnLightAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var outlineOnLightAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#216EFDFF")),
            lightColor: Color(UIColor(hex: "#1767FDFF"))
        )
    }
    static var outlineOnLightAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#90B6FEFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var outlineOnLightAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8BB2FC")),
            lightColor: Color(UIColor(hex: "#8BB2FC"))
        )
    }
    static var outlineOnLightAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#6FA0FBFF")),
            lightColor: Color(UIColor(hex: "#6599FBFF"))
        )
    }
    static var outlineOnLightAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DCE8FEFF")),
            lightColor: Color(UIColor(hex: "#B4CEFDFF"))
        )
    ...
    static var outlineOnLightAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var outlineOnLightAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A93BF1FF")),
            lightColor: Color(UIColor(hex: "#A432F1FF"))
        )
    }
    static var outlineOnLightAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D7A4F9FF")),
            lightColor: Color(UIColor(hex: "#C67EF6FF"))
        )
    }
    static var outlineOnLightAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D39CF7")),
            lightColor: Color(UIColor(hex: "#D39CF7"))
        )
    }
    static var outlineOnLightAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C680F5FF")),
            lightColor: Color(UIColor(hex: "#C276F4FF"))
        )
    }
    static var outlineOnLightAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E7FDFF")),
            lightColor: Color(UIColor(hex: "#E3C2FAFF"))
        )
    }
    static var outlineOnLightAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var outlineOnLightAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var outlineOnLightAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var outlineOnLightAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var outlineOnLightAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var outlineOnLightAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    ...
    static var outlineOnLightTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF33")),
            lightColor: Color(UIColor(hex: "#118CDF33"))
        )
    }
    static var outlineOnLightTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF3D")),
            lightColor: Color(UIColor(hex: "#118CDF3D"))
        )
    }
    static var outlineOnLightTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDFFF")),
            lightColor: Color(UIColor(hex: "#118CDFFF"))
        )
    }
    static var outlineOnLightTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var outlineOnLightTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var outlineOnLightTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32FF")),
            lightColor: Color(UIColor(hex: "#1A9E32FF"))
        )
    }
    static var outlineOnLightTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD33")),
            lightColor: Color(UIColor(hex: "#3F81FD33"))
        )
    }
    static var outlineOnLightTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD3D")),
            lightColor: Color(UIColor(hex: "#3F82FD3D"))
        )
    }
    static var outlineOnLightTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FDFF")),
            lightColor: Color(UIColor(hex: "#3F82FDFF"))
        )
    ...
    static var outlineOnLightTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F333")),
            lightColor: Color(UIColor(hex: "#B559F333"))
        )
    }
    static var outlineOnLightTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F33D")),
            lightColor: Color(UIColor(hex: "#B558F33D"))
        )
    }
    static var outlineOnLightTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F3FF")),
            lightColor: Color(UIColor(hex: "#B558F3FF"))
        )
    }
    static var outlineOnLightTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var outlineOnLightTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var outlineOnLightTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32FF")),
            lightColor: Color(UIColor(hex: "#1A9E32FF"))
        )
    ...
    static var overlayOnDarkBlur: Self {
        Self(
            darkColor: Color(UIColor(hex: "#26262647")),
            lightColor: Color(UIColor(hex: "#26262647"))
        )
    }
    static var overlayOnDarkHard: Self {
        Self(
            darkColor: Color(UIColor(hex: "#000000EB")),
            lightColor: Color(UIColor(hex: "#000000EB"))
        )
    }
    ...
    static var surfaceDefaultAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var surfaceDefaultAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1086D5FF")),
            lightColor: Color(UIColor(hex: "#0F81CCFF"))
        )
    }
    static var surfaceDefaultAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1798EEFF")),
            lightColor: Color(UIColor(hex: "#1798EEFF"))
        )
    }
    static var surfaceDefaultAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C283B")),
            lightColor: Color(UIColor(hex: "#CFECFF"))
        )
    }
    static var surfaceDefaultAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2333FF")),
            lightColor: Color(UIColor(hex: "#C7E9FFFF"))
        )
    }
    static var surfaceDefaultAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10344CFF")),
            lightColor: Color(UIColor(hex: "#E5F5FFFF"))
        )
    }
    static var surfaceDefaultAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceDefaultAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceDefaultAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceDefaultAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2B10")),
            lightColor: Color(UIColor(hex: "#9EFAAF"))
        )
    }
    static var surfaceDefaultAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08210CFF")),
            lightColor: Color(UIColor(hex: "#8BF99FFF"))
        )
    }
    static var surfaceDefaultAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E3A16FF")),
            lightColor: Color(UIColor(hex: "#B1FBBFFF"))
        )
    }
    static var surfaceDefaultAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceDefaultAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceDefaultAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceDefaultAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#082254")),
            lightColor: Color(UIColor(hex: "#DEE9FF"))
        )
    }
    static var surfaceDefaultAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#071F4BFF")),
            lightColor: Color(UIColor(hex: "#D6E4FFFF"))
        )
    }
    static var surfaceDefaultAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2A67FF")),
            lightColor: Color(UIColor(hex: "#F5F8FFFF"))
        )
    }
    ...
    static var surfaceDefaultAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var surfaceDefaultAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B14FF3FF")),
            lightColor: Color(UIColor(hex: "#AD45F2FF"))
        )
    }
    static var surfaceDefaultAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C275F5FF")),
            lightColor: Color(UIColor(hex: "#C275F5FF"))
        )
    }
    static var surfaceDefaultAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#36154C")),
            lightColor: Color(UIColor(hex: "#F4E3FF"))
        )
    }
    static var surfaceDefaultAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#301344FF")),
            lightColor: Color(UIColor(hex: "#F1DBFFFF"))
        )
    }
    static var surfaceDefaultAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#41195CFF")),
            lightColor: Color(UIColor(hex: "#F9F0FFFF"))
        )
    }
    static var surfaceDefaultAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceDefaultAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceDefaultAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceDefaultAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2B10")),
            lightColor: Color(UIColor(hex: "#9EFAAF"))
        )
    }
    static var surfaceDefaultAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08210CFF")),
            lightColor: Color(UIColor(hex: "#8BF99FFF"))
        )
    }
    static var surfaceDefaultAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E3A16FF")),
            lightColor: Color(UIColor(hex: "#B1FBBFFF"))
        )
    ...
    static var surfaceDefaultSkeletonActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    static var surfaceDefaultSkeletonHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    ...
    static var surfaceDefaultSolidCardBrightness: Self {
        Self(
            darkColor: Color(UIColor(hex: "#262626FF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    ...
    static var surfaceDefaultSpeechBubbleReceived: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF0F")),
            lightColor: Color(UIColor(hex: "#08080808"))
        )
    }
    static var surfaceDefaultSpeechBubbleReceivedActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF0A")),
            lightColor: Color(UIColor(hex: "#0808080D"))
        )
    }
    static var surfaceDefaultSpeechBubbleReceivedHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF1F")),
            lightColor: Color(UIColor(hex: "#08080803"))
        )
    }
    static var surfaceDefaultSpeechBubbleSent: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080847")),
            lightColor: Color(UIColor(hex: "#08080866"))
        )
    }
    static var surfaceDefaultSpeechBubbleSentActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080838")),
            lightColor: Color(UIColor(hex: "#08080870"))
        )
    }
    static var surfaceDefaultSpeechBubbleSentHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080866")),
            lightColor: Color(UIColor(hex: "#08080852"))
        )
    }
    static var surfaceDefaultSurfaceTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var surfaceDefaultSurfaceTransparentAccentMainHover: Self {
        Self(
    ...
    static var surfaceDefaultTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF33")),
            lightColor: Color(UIColor(hex: "#118CDF1F"))
        )
    }
    static var surfaceDefaultTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF24")),
            lightColor: Color(UIColor(hex: "#118CDF29"))
        )
    }
    static var surfaceDefaultTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF52")),
            lightColor: Color(UIColor(hex: "#118CDF0A"))
        )
    }
    static var surfaceDefaultTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceDefaultTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3224")),
            lightColor: Color(UIColor(hex: "#1A9E3229"))
        )
    }
    static var surfaceDefaultTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3252")),
            lightColor: Color(UIColor(hex: "#1A9E320A"))
        )
    }
    static var surfaceDefaultTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD33")),
            lightColor: Color(UIColor(hex: "#3F81FD1F"))
        )
    }
    static var surfaceDefaultTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD24")),
            lightColor: Color(UIColor(hex: "#3F82FD29"))
        )
    }
    static var surfaceDefaultTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD52")),
            lightColor: Color(UIColor(hex: "#3F82FD0A"))
        )
    }
    ...
    static var surfaceDefaultTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F333")),
            lightColor: Color(UIColor(hex: "#B559F31F"))
        )
    }
    static var surfaceDefaultTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F324")),
            lightColor: Color(UIColor(hex: "#B558F329"))
        )
    }
    static var surfaceDefaultTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F352")),
            lightColor: Color(UIColor(hex: "#B558F30A"))
        )
    }
    static var surfaceDefaultTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceDefaultTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3224")),
            lightColor: Color(UIColor(hex: "#1A9E3229"))
        )
    }
    static var surfaceDefaultTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3252")),
            lightColor: Color(UIColor(hex: "#1A9E320A"))
        )
    ...
    static var surfaceInverseAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var surfaceInverseAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1086D5FF")),
            lightColor: Color(UIColor(hex: "#0F81CCFF"))
        )
    }
    static var surfaceInverseAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1798EEFF")),
            lightColor: Color(UIColor(hex: "#1798EEFF"))
        )
    }
    static var surfaceInverseAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#CFECFF")),
            lightColor: Color(UIColor(hex: "#0C283B"))
        )
    }
    static var surfaceInverseAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C7E9FFFF")),
            lightColor: Color(UIColor(hex: "#091D2AFF"))
        )
    }
    static var surfaceInverseAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DBF1FFFF")),
            lightColor: Color(UIColor(hex: "#10344CFF"))
        )
    }
    static var surfaceInverseAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceInverseAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceInverseAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceInverseAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#9EFAAF")),
            lightColor: Color(UIColor(hex: "#0A2B10"))
        )
    }
    static var surfaceInverseAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#94F9A7FF")),
            lightColor: Color(UIColor(hex: "#061909FF"))
        )
    }
    static var surfaceInverseAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B1FBBFFF")),
            lightColor: Color(UIColor(hex: "#0E3A16FF"))
        )
    }
    static var surfaceInverseAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceInverseAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceInverseAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceInverseAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DEE9FF")),
            lightColor: Color(UIColor(hex: "#082254"))
        )
    }
    static var surfaceInverseAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D6E4FFFF")),
            lightColor: Color(UIColor(hex: "#061B41FF"))
        )
    }
    static var surfaceInverseAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#EBF1FFFF")),
            lightColor: Color(UIColor(hex: "#0A2A67FF"))
        )
    }
    ...
    static var surfaceInverseAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var surfaceInverseAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B14FF3FF")),
            lightColor: Color(UIColor(hex: "#B14FF3FF"))
        )
    }
    static var surfaceInverseAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C275F5FF")),
            lightColor: Color(UIColor(hex: "#C275F5FF"))
        )
    }
    static var surfaceInverseAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E3FF")),
            lightColor: Color(UIColor(hex: "#36154C"))
        )
    }
    static var surfaceInverseAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F1DBFFFF")),
            lightColor: Color(UIColor(hex: "#2B103CFF"))
        )
    }
    static var surfaceInverseAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F9F0FFFF")),
            lightColor: Color(UIColor(hex: "#41195CFF"))
        )
    }
    static var surfaceInverseAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceInverseAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceInverseAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceInverseAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#9EFAAF")),
            lightColor: Color(UIColor(hex: "#0A2B10"))
        )
    }
    static var surfaceInverseAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#94F9A7FF")),
            lightColor: Color(UIColor(hex: "#061909FF"))
        )
    }
    static var surfaceInverseAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B1FBBFFF")),
            lightColor: Color(UIColor(hex: "#0E3A16FF"))
        )
    ...
    static var surfaceInverseSurfaceAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var surfaceInverseSurfaceAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#AD45F2FF")),
            lightColor: Color(UIColor(hex: "#AD45F2FF"))
        )
    }
    static var surfaceInverseSurfaceAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C275F5FF")),
            lightColor: Color(UIColor(hex: "#C275F5FF"))
        )
    ...
    static var surfaceInverseTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF1F")),
            lightColor: Color(UIColor(hex: "#118CDF33"))
        )
    }
    static var surfaceInverseTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF0F")),
            lightColor: Color(UIColor(hex: "#118CDF3D"))
        )
    }
    static var surfaceInverseTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF3D")),
            lightColor: Color(UIColor(hex: "#118CDF1F"))
        )
    }
    static var surfaceInverseTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E321F")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var surfaceInverseTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E320F")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var surfaceInverseTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceInverseTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD1F")),
            lightColor: Color(UIColor(hex: "#3F81FD33"))
        )
    }
    static var surfaceInverseTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD0F")),
            lightColor: Color(UIColor(hex: "#3F82FD3D"))
        )
    }
    static var surfaceInverseTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD3D")),
            lightColor: Color(UIColor(hex: "#3F82FD1F"))
        )
    }
    ...
    static var surfaceInverseTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F31F")),
            lightColor: Color(UIColor(hex: "#B559F333"))
        )
    }
    static var surfaceInverseTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F30F")),
            lightColor: Color(UIColor(hex: "#B558F33D"))
        )
    }
    static var surfaceInverseTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F33D")),
            lightColor: Color(UIColor(hex: "#B558F31F"))
        )
    }
    static var surfaceInverseTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E321F")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var surfaceInverseTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E320F")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var surfaceInverseTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    ...
    static var surfaceOnDarkAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var surfaceOnDarkAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1086D5FF")),
            lightColor: Color(UIColor(hex: "#0F81CCFF"))
        )
    }
    static var surfaceOnDarkAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1798EEFF")),
            lightColor: Color(UIColor(hex: "#1798EEFF"))
        )
    }
    static var surfaceOnDarkAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C283B")),
            lightColor: Color(UIColor(hex: "#0C283B"))
        )
    }
    static var surfaceOnDarkAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2333FF")),
            lightColor: Color(UIColor(hex: "#091D2AFF"))
        )
    }
    static var surfaceOnDarkAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10344CFF")),
            lightColor: Color(UIColor(hex: "#10344CFF"))
        )
    }
    static var surfaceOnDarkAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceOnDarkAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceOnDarkAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceOnDarkAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2B10")),
            lightColor: Color(UIColor(hex: "#0A2B10"))
        )
    }
    static var surfaceOnDarkAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08210CFF")),
            lightColor: Color(UIColor(hex: "#061909FF"))
        )
    }
    static var surfaceOnDarkAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E3A16FF")),
            lightColor: Color(UIColor(hex: "#0E3A16FF"))
        )
    }
    static var surfaceOnDarkAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceOnDarkAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceOnDarkAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceOnDarkAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#082254")),
            lightColor: Color(UIColor(hex: "#082254"))
        )
    }
    static var surfaceOnDarkAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#071F4BFF")),
            lightColor: Color(UIColor(hex: "#061B41FF"))
        )
    }
    static var surfaceOnDarkAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2A67FF")),
            lightColor: Color(UIColor(hex: "#0A2A67FF"))
        )
    ...
    static var surfaceOnDarkAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var surfaceOnDarkAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B14FF3FF")),
            lightColor: Color(UIColor(hex: "#AD45F2FF"))
        )
    }
    static var surfaceOnDarkAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C275F5FF")),
            lightColor: Color(UIColor(hex: "#C275F5FF"))
        )
    }
    static var surfaceOnDarkAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#36154C")),
            lightColor: Color(UIColor(hex: "#36154C"))
        )
    }
    static var surfaceOnDarkAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#301344FF")),
            lightColor: Color(UIColor(hex: "#2B103CFF"))
        )
    }
    static var surfaceOnDarkAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#41195CFF")),
            lightColor: Color(UIColor(hex: "#41195CFF"))
        )
    }
    static var surfaceOnDarkAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceOnDarkAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceOnDarkAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceOnDarkAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A2B10")),
            lightColor: Color(UIColor(hex: "#0A2B10"))
        )
    }
    static var surfaceOnDarkAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08210CFF")),
            lightColor: Color(UIColor(hex: "#061909FF"))
        )
    }
    static var surfaceOnDarkAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E3A16FF")),
            lightColor: Color(UIColor(hex: "#0E3A16FF"))
        )
    ...
    static var surfaceOnDarkTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF33")),
            lightColor: Color(UIColor(hex: "#118CDF33"))
        )
    }
    static var surfaceOnDarkTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF24")),
            lightColor: Color(UIColor(hex: "#118CDF3D"))
        )
    }
    static var surfaceOnDarkTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF52")),
            lightColor: Color(UIColor(hex: "#118CDF1F"))
        )
    }
    static var surfaceOnDarkTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var surfaceOnDarkTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3224")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var surfaceOnDarkTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3252")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceOnDarkTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD33")),
            lightColor: Color(UIColor(hex: "#3F81FD33"))
        )
    }
    static var surfaceOnDarkTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD24")),
            lightColor: Color(UIColor(hex: "#3F82FD3D"))
        )
    }
    static var surfaceOnDarkTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD52")),
            lightColor: Color(UIColor(hex: "#3F82FD1F"))
        )
    ...
    static var surfaceOnDarkTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F333")),
            lightColor: Color(UIColor(hex: "#B559F333"))
        )
    }
    static var surfaceOnDarkTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F324")),
            lightColor: Color(UIColor(hex: "#B558F33D"))
        )
    }
    static var surfaceOnDarkTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F352")),
            lightColor: Color(UIColor(hex: "#B558F31F"))
        )
    }
    static var surfaceOnDarkTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3233")),
            lightColor: Color(UIColor(hex: "#1A9E3233"))
        )
    }
    static var surfaceOnDarkTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3224")),
            lightColor: Color(UIColor(hex: "#1A9E323D"))
        )
    }
    static var surfaceOnDarkTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E3252")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    ...
    static var surfaceOnLightAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var surfaceOnLightAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1086D5FF")),
            lightColor: Color(UIColor(hex: "#0F81CCFF"))
        )
    }
    static var surfaceOnLightAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1798EEFF")),
            lightColor: Color(UIColor(hex: "#1798EEFF"))
        )
    }
    static var surfaceOnLightAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#CFECFF")),
            lightColor: Color(UIColor(hex: "#CFECFF"))
        )
    }
    static var surfaceOnLightAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C7E9FFFF")),
            lightColor: Color(UIColor(hex: "#C7E9FFFF"))
        )
    }
    static var surfaceOnLightAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DBF1FFFF")),
            lightColor: Color(UIColor(hex: "#E5F5FFFF"))
        )
    }
    static var surfaceOnLightAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceOnLightAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceOnLightAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceOnLightAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#9EFAAF")),
            lightColor: Color(UIColor(hex: "#9EFAAF"))
        )
    }
    static var surfaceOnLightAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#94F9A7FF")),
            lightColor: Color(UIColor(hex: "#8BF99FFF"))
        )
    }
    static var surfaceOnLightAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B1FBBFFF")),
            lightColor: Color(UIColor(hex: "#B1FBBFFF"))
        )
    }
    static var surfaceOnLightAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceOnLightAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceOnLightAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceOnLightAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DEE9FF")),
            lightColor: Color(UIColor(hex: "#DEE9FF"))
        )
    }
    static var surfaceOnLightAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D6E4FFFF")),
            lightColor: Color(UIColor(hex: "#D6E4FFFF"))
        )
    }
    static var surfaceOnLightAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#EBF1FFFF")),
            lightColor: Color(UIColor(hex: "#F5F8FFFF"))
        )
    ...
    static var surfaceOnLightAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var surfaceOnLightAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B14FF3FF")),
            lightColor: Color(UIColor(hex: "#AD45F2FF"))
        )
    }
    static var surfaceOnLightAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C275F5FF")),
            lightColor: Color(UIColor(hex: "#C275F5FF"))
        )
    }
    static var surfaceOnLightAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E3FF")),
            lightColor: Color(UIColor(hex: "#F4E3FF"))
        )
    }
    static var surfaceOnLightAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F1DBFFFF")),
            lightColor: Color(UIColor(hex: "#F1DBFFFF"))
        )
    }
    static var surfaceOnLightAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F9F0FFFF")),
            lightColor: Color(UIColor(hex: "#F9F0FFFF"))
        )
    }
    static var surfaceOnLightAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var surfaceOnLightAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#18952FFF")),
            lightColor: Color(UIColor(hex: "#178C2CFF"))
        )
    }
    static var surfaceOnLightAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1DAF37FF")),
            lightColor: Color(UIColor(hex: "#1EB83AFF"))
        )
    }
    static var surfaceOnLightAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#9EFAAF")),
            lightColor: Color(UIColor(hex: "#9EFAAF"))
        )
    }
    static var surfaceOnLightAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#94F9A7FF")),
            lightColor: Color(UIColor(hex: "#8BF99FFF"))
        )
    }
    static var surfaceOnLightAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B1FBBFFF")),
            lightColor: Color(UIColor(hex: "#B1FBBFFF"))
        )
    ...
    static var surfaceOnLightTransparentAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF1F")),
            lightColor: Color(UIColor(hex: "#118CDF1F"))
        )
    }
    static var surfaceOnLightTransparentAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF0F")),
            lightColor: Color(UIColor(hex: "#118CDF29"))
        )
    }
    static var surfaceOnLightTransparentAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF3D")),
            lightColor: Color(UIColor(hex: "#118CDF0A"))
        )
    }
    static var surfaceOnLightTransparentAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E321F")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceOnLightTransparentAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E320F")),
            lightColor: Color(UIColor(hex: "#1A9E3229"))
        )
    }
    static var surfaceOnLightTransparentAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E320A"))
        )
    }
    static var surfaceOnLightTransparentAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD1F")),
            lightColor: Color(UIColor(hex: "#3F81FD1F"))
        )
    }
    static var surfaceOnLightTransparentAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD0F")),
            lightColor: Color(UIColor(hex: "#3F82FD29"))
        )
    }
    static var surfaceOnLightTransparentAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F82FD3D")),
            lightColor: Color(UIColor(hex: "#3F82FD0A"))
        )
    ...
    static var surfaceOnLightTransparentAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F31F")),
            lightColor: Color(UIColor(hex: "#B559F31F"))
        )
    }
    static var surfaceOnLightTransparentAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F30F")),
            lightColor: Color(UIColor(hex: "#B558F329"))
        )
    }
    static var surfaceOnLightTransparentAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B558F33D")),
            lightColor: Color(UIColor(hex: "#B558F30A"))
        )
    }
    static var surfaceOnLightTransparentAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E321F")),
            lightColor: Color(UIColor(hex: "#1A9E321F"))
        )
    }
    static var surfaceOnLightTransparentAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E320F")),
            lightColor: Color(UIColor(hex: "#1A9E3229"))
        )
    }
    static var surfaceOnLightTransparentAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E323D")),
            lightColor: Color(UIColor(hex: "#1A9E320A"))
        )
    ...
    static var surfaceOnLightTransparentDeep: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808A2")),
            lightColor: Color(UIColor(hex: "#080808A2"))
        )
    }
    static var surfaceOnLightTransparentDeepActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080894")),
            lightColor: Color(UIColor(hex: "#080808AD"))
        )
    }
    static var surfaceOnLightTransparentDeepHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808C2")),
            lightColor: Color(UIColor(hex: "#0808088F"))
        )
    }
    ...
    static var textDefaultAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var textDefaultAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E8ADDFF")),
            lightColor: Color(UIColor(hex: "#0E75B9FF"))
        )
    }
    static var textDefaultAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#66BCF5FF")),
            lightColor: Color(UIColor(hex: "#2AA0EFFF"))
        )
    }
    static var textDefaultAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0D5382")),
            lightColor: Color(UIColor(hex: "#52BAFF"))
        )
    }
    static var textDefaultAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10659EFF")),
            lightColor: Color(UIColor(hex: "#29A9FFFF"))
        )
    }
    static var textDefaultAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1277BAFF")),
            lightColor: Color(UIColor(hex: "#7ACAFFFF"))
        )
    }
    static var textDefaultAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textDefaultAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textDefaultAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textDefaultAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var textDefaultAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var textDefaultAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    }
    static var textDefaultAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var textDefaultAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#337AFFFF")),
            lightColor: Color(UIColor(hex: "#1767FDFF"))
        )
    }
    static var textDefaultAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3C3FFFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var textDefaultAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1549AB")),
            lightColor: Color(UIColor(hex: "#8BB2FC"))
        )
    }
    static var textDefaultAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1C62E3FF")),
            lightColor: Color(UIColor(hex: "#6599FBFF"))
        )
    }
    static var textDefaultAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#B4CEFDFF"))
        )
    ...
    static var textDefaultAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var textDefaultAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B84DFFFF")),
            lightColor: Color(UIColor(hex: "#A432F1FF"))
        )
    }
    static var textDefaultAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E4BDFFFF")),
            lightColor: Color(UIColor(hex: "#C67EF6FF"))
        )
    }
    static var textDefaultAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D39CF7")),
            lightColor: Color(UIColor(hex: "#D39CF7"))
        )
    }
    static var textDefaultAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C680F5FF")),
            lightColor: Color(UIColor(hex: "#C276F4FF"))
        )
    }
    static var textDefaultAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E7FDFF")),
            lightColor: Color(UIColor(hex: "#E3C2FAFF"))
        )
    }
    static var textDefaultAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textDefaultAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textDefaultAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textDefaultAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var textDefaultAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var textDefaultAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    ...
    static var textDefaultParagraph: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFCC")),
            lightColor: Color(UIColor(hex: "#080808CC"))
        )
    }
    static var textDefaultParagraphActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFA3")),
            lightColor: Color(UIColor(hex: "#080808A3"))
        )
    }
    ...
    static var textDefaultPrimary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFF5")),
            lightColor: Color(UIColor(hex: "#080808F5"))
        )
    }
    static var textDefaultPrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFC4")),
            lightColor: Color(UIColor(hex: "#080808C4"))
        )
    }
    ...
    static var textDefaultPrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF93")),
            lightColor: Color(UIColor(hex: "#08080893"))
        )
    }
    ...
    static var textDefaultSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFAB")),
            lightColor: Color(UIColor(hex: "#080808AB"))
        )
    }
    ...
    static var textDefaultTertiaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFF56")),
            lightColor: Color(UIColor(hex: "#08080856"))
        )
    }
    ...
    static var textInverseAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var textInverseAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F7BC2FF")),
            lightColor: Color(UIColor(hex: "#0E75B9FF"))
        )
    }
    static var textInverseAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#50B1F2FF")),
            lightColor: Color(UIColor(hex: "#2AA0EFFF"))
        )
    }
    static var textInverseAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#52BAFF")),
            lightColor: Color(UIColor(hex: "#0D5382"))
        )
    }
    static var textInverseAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#33ADFFFF")),
            lightColor: Color(UIColor(hex: "#116BA7FF"))
        )
    }
    static var textInverseAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3DAFFFF")),
            lightColor: Color(UIColor(hex: "#1483CCFF"))
        )
    }
    static var textInverseAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textInverseAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textInverseAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textInverseAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var textInverseAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var textInverseAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    }
    static var textInverseAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var textInverseAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#216EFDFF")),
            lightColor: Color(UIColor(hex: "#1767FDFF"))
        )
    }
    static var textInverseAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#90B6FEFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var textInverseAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8BB2FC")),
            lightColor: Color(UIColor(hex: "#1549AB"))
        )
    }
    static var textInverseAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#6FA0FBFF")),
            lightColor: Color(UIColor(hex: "#113B88FF"))
        )
    }
    static var textInverseAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DCE8FEFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    ...
    static var textInverseAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var textInverseAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A93BF1FF")),
            lightColor: Color(UIColor(hex: "#A432F1FF"))
        )
    }
    static var textInverseAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D7A4F9FF")),
            lightColor: Color(UIColor(hex: "#C67EF6FF"))
        )
    }
    static var textInverseAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D39CF7")),
            lightColor: Color(UIColor(hex: "#722BA1"))
        )
    }
    static var textInverseAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C680F5FF")),
            lightColor: Color(UIColor(hex: "#5B2281FF"))
        )
    }
    static var textInverseAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E7FDFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    }
    static var textInverseAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textInverseAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textInverseAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textInverseAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var textInverseAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var textInverseAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    ...
    static var textInverseParagraph: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808CC")),
            lightColor: Color(UIColor(hex: "#FFFFFFCC"))
        )
    }
    static var textInverseParagraphActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808A3")),
    ...
    static var textInversePrimary: Self {
        Self(
            ...
            lightColor: Color(UIColor(hex: "#FFFFFFF5"))
        )
    }
    static var textInversePrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808C4")),
            lightColor: Color(UIColor(hex: "#FFFFFFC4"))
        )
    }
    ...
    static var textInversePrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080893")),
            lightColor: Color(UIColor(hex: "#FFFFFF93"))
        )
    }
    ...
    static var textInverseSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#080808AB")),
            lightColor: Color(UIColor(hex: "#FFFFFFAB"))
        )
    }
    ...
    static var textInverseTertiaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08080856")),
            lightColor: Color(UIColor(hex: "#FFFFFF56"))
        )
    }
    ...
    static var textOnDarkAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#199AF0")),
            lightColor: Color(UIColor(hex: "#199AF0"))
        )
    }
    static var textOnDarkAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0E8ADDFF")),
            lightColor: Color(UIColor(hex: "#0D84D3FF"))
        )
    }
    static var textOnDarkAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#66BCF5FF")),
            lightColor: Color(UIColor(hex: "#3FABF3FF"))
        )
    }
    static var textOnDarkAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0D5382")),
            lightColor: Color(UIColor(hex: "#0D5382"))
        )
    }
    static var textOnDarkAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#10659EFF")),
            lightColor: Color(UIColor(hex: "#116BA7FF"))
        )
    }
    static var textOnDarkAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1277BAFF")),
            lightColor: Color(UIColor(hex: "#1483CCFF"))
        )
    }
    static var textOnDarkAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var textOnDarkAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var textOnDarkAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var textOnDarkAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var textOnDarkAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var textOnDarkAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    }
    static var textOnDarkAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#528EFF")),
            lightColor: Color(UIColor(hex: "#528EFF"))
        )
    }
    static var textOnDarkAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#337AFFFF")),
            lightColor: Color(UIColor(hex: "#2974FFFF"))
        )
    }
    static var textOnDarkAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3C3FFFF")),
            lightColor: Color(UIColor(hex: "#7AA9FFFF"))
        )
    }
    static var textOnDarkAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1549AB")),
            lightColor: Color(UIColor(hex: "#1549AB"))
        )
    }
    static var textOnDarkAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1C62E3FF")),
            lightColor: Color(UIColor(hex: "#113B88FF"))
        )
    }
    static var textOnDarkAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    ...
    static var textOnDarkAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C46BFF")),
            lightColor: Color(UIColor(hex: "#C46BFF"))
        )
    }
    static var textOnDarkAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B84DFFFF")),
            lightColor: Color(UIColor(hex: "#B442FFFF"))
        )
    }
    static var textOnDarkAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E4BDFFFF")),
            lightColor: Color(UIColor(hex: "#D494FFFF"))
        )
    }
    static var textOnDarkAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#722BA1")),
            lightColor: Color(UIColor(hex: "#722BA1"))
        )
    }
    static var textOnDarkAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8933C1FF")),
            lightColor: Color(UIColor(hex: "#5B2281FF"))
        )
    }
    static var textOnDarkAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#000000FF"))
        )
    }
    static var textOnDarkAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24B23E")),
            lightColor: Color(UIColor(hex: "#24B23E"))
        )
    }
    static var textOnDarkAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F9835FF")),
            lightColor: Color(UIColor(hex: "#1D9032FF"))
        )
    }
    static var textOnDarkAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2ACB47FF")),
            lightColor: Color(UIColor(hex: "#2BD44AFF"))
        )
    }
    static var textOnDarkAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#095C18")),
            lightColor: Color(UIColor(hex: "#095C18"))
        )
    }
    static var textOnDarkAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C7920FF")),
            lightColor: Color(UIColor(hex: "#0D8222FF"))
        )
    }
    static var textOnDarkAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F9527FF")),
            lightColor: Color(UIColor(hex: "#11A72CFF"))
        )
    ...
    static var textOnLightAccentAthena: Self {
        Self(
            darkColor: Color(UIColor(hex: "#118CDF")),
            lightColor: Color(UIColor(hex: "#118CDF"))
        )
    }
    static var textOnLightAccentAthenaActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0F7BC2FF")),
            lightColor: Color(UIColor(hex: "#0E75B9FF"))
        )
    }
    static var textOnLightAccentAthenaHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#50B1F2FF")),
            lightColor: Color(UIColor(hex: "#2AA0EFFF"))
        )
    }
    static var textOnLightAccentAthenaMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#52BAFF")),
            lightColor: Color(UIColor(hex: "#52BAFF"))
        )
    }
    static var textOnLightAccentAthenaMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#33ADFFFF")),
            lightColor: Color(UIColor(hex: "#29A9FFFF"))
        )
    }
    static var textOnLightAccentAthenaMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A3DAFFFF")),
            lightColor: Color(UIColor(hex: "#7ACAFFFF"))
        )
    }
    static var textOnLightAccentB2E: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textOnLightAccentB2EActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textOnLightAccentB2EHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textOnLightAccentB2EMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var textOnLightAccentB2EMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var textOnLightAccentB2EMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )
    }
    static var textOnLightAccentBrand: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var textOnLightAccentBrandActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#216EFDFF")),
            lightColor: Color(UIColor(hex: "#1767FDFF"))
        )
    }
    static var textOnLightAccentBrandHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#90B6FEFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var textOnLightAccentBrandMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8BB2FC")),
            lightColor: Color(UIColor(hex: "#8BB2FC"))
        )
    }
    static var textOnLightAccentBrandMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#6FA0FBFF")),
            lightColor: Color(UIColor(hex: "#6599FBFF"))
        )
    }
    static var textOnLightAccentBrandMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DCE8FEFF")),
            lightColor: Color(UIColor(hex: "#B4CEFDFF"))
        )
    ...
    static var textOnLightAccentJoy: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B559F3")),
            lightColor: Color(UIColor(hex: "#B559F3"))
        )
    }
    static var textOnLightAccentJoyActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A93BF1FF")),
            lightColor: Color(UIColor(hex: "#A432F1FF"))
        )
    }
    static var textOnLightAccentJoyHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D7A4F9FF")),
            lightColor: Color(UIColor(hex: "#C67EF6FF"))
        )
    }
    static var textOnLightAccentJoyMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D39CF7")),
            lightColor: Color(UIColor(hex: "#D39CF7"))
        )
    }
    static var textOnLightAccentJoyMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C680F5FF")),
            lightColor: Color(UIColor(hex: "#C276F4FF"))
        )
    }
    static var textOnLightAccentJoyMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F4E7FDFF")),
            lightColor: Color(UIColor(hex: "#E3C2FAFF"))
        )
    }
    static var textOnLightAccentMain: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1A9E32")),
            lightColor: Color(UIColor(hex: "#1A9E32"))
        )
    }
    static var textOnLightAccentMainActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15842AFF")),
            lightColor: Color(UIColor(hex: "#147B27FF"))
        )
    }
    static var textOnLightAccentMainHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1EB83AFF")),
            lightColor: Color(UIColor(hex: "#1FC13DFF"))
        )
    }
    static var textOnLightAccentMainMinor: Self {
        Self(
            darkColor: Color(UIColor(hex: "#28D247")),
            lightColor: Color(UIColor(hex: "#28D247"))
        )
    }
    static var textOnLightAccentMainMinorActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23B83EFF")),
            lightColor: Color(UIColor(hex: "#21B03CFF"))
        )
    }
    static var textOnLightAccentMainMinorHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3EDA5BFF")),
            lightColor: Color(UIColor(hex: "#47DC62FF"))
        )

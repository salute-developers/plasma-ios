...
private extension ButtonAppearance {
    ...
    var accent: ButtonAppearance {
        var appearance = self
        appearance.iconColor = ButtonColor(defaultColor: ColorToken.textDefaultAccentMain, highlightedColor: ColorToken.textDefaultAccentMainActive, hoveredColor: ColorToken.textDefaultAccentMainHover)
        appearance.spinnerColor = ButtonColor(defaultColor: ColorToken.textDefaultAccentMain, highlightedColor: ColorToken.textDefaultAccentMainActive, hoveredColor: ColorToken.textDefaultAccentMainHover)
        appearance.titleColor = ButtonColor(defaultColor: ColorToken.textDefaultAccentMain, highlightedColor: ColorToken.textDefaultAccentMainActive, hoveredColor: ColorToken.textDefaultAccentMainHover)
        return appearance
    }

...
private extension ButtonAppearance {
    ...
    var accent: ButtonAppearance {
        var appearance = self
        appearance.iconColor = ButtonColor(StatefulColor(defaultValue: ColorToken.textDefaultAccentMain, values: [
            .init(states: [InteractiveState.pressed], value: ColorToken.textDefaultAccentMainActive),
            .init(states: [InteractiveState.hovered], value: ColorToken.textDefaultAccentMainHover)
        ]))
        appearance.spinnerColor = ButtonColor(StatefulColor(defaultValue: ColorToken.textDefaultAccentMain, values: [
            .init(states: [InteractiveState.pressed], value: ColorToken.textDefaultAccentMainActive),
            .init(states: [InteractiveState.hovered], value: ColorToken.textDefaultAccentMainHover)
        ]))
        appearance.titleColor = ButtonColor(StatefulColor(defaultValue: ColorToken.textDefaultAccentMain, values: [
            .init(states: [InteractiveState.pressed], value: ColorToken.textDefaultAccentMainActive),
            .init(states: [InteractiveState.hovered], value: ColorToken.textDefaultAccentMainHover)
        ]))
        return appearance

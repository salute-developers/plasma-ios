...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.Buttonstretch> {
    ...
    var buttonStretch: GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.Buttonstretch> {
        var size =  NotificationContentAnySize(size: appearance.size)
        size.contentStartPadding = CGFloat(4.0)
        size.contentTopPadding = CGFloat(2.0)
...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.ButtonstretchIconstart> {
...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.ButtonstretchIcontop> {
...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.Nobuttonstretch> {
    ...
    var noButtonStretch: GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.Nobuttonstretch> {
        var size =  NotificationContentAnySize(size: appearance.size)
        size.contentTopPadding = CGFloat(4.0)
        size.textBoxStartPadding = CGFloat(2.0)
        size.textBoxTopPadding = CGFloat(3.0)
...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.NobuttonstretchIconstart> {
...
public extension GeneralAppearanceVariation<NotificationContent, NotificationContentAppearance, NotificationContentVariation.NobuttonstretchIcontop> {

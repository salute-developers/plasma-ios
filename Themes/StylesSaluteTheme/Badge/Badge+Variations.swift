...
private extension BadgeAppearance {
    ...
    var `default`: BadgeAppearance {
        ...
        appearance.endContentColor = StatefulFillStyle(defaultValue: .color(.textInversePrimary), values: [])
        appearance.labelColor = StatefulFillStyle(defaultValue: .color(.textInversePrimary), values: [])
        appearance.startContentColor = StatefulFillStyle(defaultValue: .color(.textInversePrimary), values: [])
        return appearance
    }
    
    var accent: BadgeAppearance {
        var appearance = self
        appearance.backgroundColor = StatefulFillStyle(defaultValue: .color(.surfaceDefaultAccentMain), values: [])
    ...
    var light: BadgeAppearance {
        ...
        appearance.endContentColor = StatefulFillStyle(defaultValue: .color(.textOnLightPrimary), values: [])
        appearance.labelColor = StatefulFillStyle(defaultValue: .color(.textOnLightPrimary), values: [])
        appearance.startContentColor = StatefulFillStyle(defaultValue: .color(.textOnLightPrimary), values: [])
        return appearance
    }

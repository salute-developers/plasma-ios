...
public extension ColorToken {
    ...
    static var surfaceDefaultAccent: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0064FEFF")),
            lightColor: Color(UIColor(hex: "#0064FEFF"))
        )
    }
    
    static var surfaceDefaultAccentActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0062F5FF")),
            lightColor: Color(UIColor(hex: "#005EEBFF"))
        )
    }
    ...
    static var surfaceDefaultAccentHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F78FFFF")),
            lightColor: Color(UIColor(hex: "#297EFFFF"))
        )
    }
    ...
    static var textDefaultAccentActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#005AE0FF")),
            lightColor: Color(UIColor(hex: "#0056D6FF"))
        )
    }
    ...
    static var textDefaultAccentHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5297FFFF")),
            lightColor: Color(UIColor(hex: "#297EFFFF"))
        )
    }

...
public extension ColorToken {
    ...
    static var backgroundDefaultOverlay: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15181A8F")),
            lightColor: Color(UIColor(hex: "#15181A8F"))
        )
    }
    static var backgroundDefaultPrimary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#08090AFF")),
            lightColor: Color(UIColor(hex: "#F7F8FAFF"))
        )
    }
    ...
    static var bannerDefaultBlue: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F7FF")),
            lightColor: Color(UIColor(hex: "#F2F7FF"))
        )
    }
    static var bannerDefaultGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFF7D6")),
            lightColor: Color(UIColor(hex: "#FFF7D6"))
        )
    }
    static var bannerDefaultGreen: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E0FFE9")),
            lightColor: Color(UIColor(hex: "#E0FFE9"))
        )
    }
    static var bannerDefaultMalachite: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E6FCFC")),
            lightColor: Color(UIColor(hex: "#E6FCFC"))
        )
    }
    static var bannerDefaultRed: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFF5F6")),
            lightColor: Color(UIColor(hex: "#FFF5F6"))
        )
    }
    static var bannersDefaultBannerBlue: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A162B")),
            lightColor: Color(UIColor(hex: "#0A162B"))
        )
    }
    static var bannersDefaultBannerGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1F1903")),
            lightColor: Color(UIColor(hex: "#1F1903"))
        )
    }
    static var bannersDefaultBannerGreen: Self {
        Self(
            darkColor: Color(UIColor(hex: "#071F0C")),
            lightColor: Color(UIColor(hex: "#071F0C"))
        )
    }
    static var bannersDefaultBannerMalachite: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0A1C1C")),
            lightColor: Color(UIColor(hex: "#0A1C1C"))
        )
    }
    static var bannersDefaultBannerRed: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2E090D")),
            lightColor: Color(UIColor(hex: "#2E090D"))
        )
    }
    ...
    static var surfaceDefaultAccent: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E40421FF")),
            lightColor: Color(UIColor(hex: "#E40421FF"))
        )
    }
    static var surfaceDefaultAccentActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D80320FF")),
            lightColor: Color(UIColor(hex: "#CE031EFF"))
        )
    }
    static var surfaceDefaultAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0DA8AB")),
            lightColor: Color(UIColor(hex: "#0DA8AB"))
        )
    }
    static var surfaceDefaultAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C9FA1FF")),
            lightColor: Color(UIColor(hex: "#0B9598FF"))
        )
    }
    static var surfaceDefaultAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0EBBBEFF")),
            lightColor: Color(UIColor(hex: "#0EBBBEFF"))
        )
    }
    static var surfaceDefaultAccentBlue: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5993FFFF")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceDefaultAccentBlueActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#4D8BFFFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceDefaultAccentBlueHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#75A5FFFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceDefaultAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var surfaceDefaultAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1472FF")),
            lightColor: Color(UIColor(hex: "#FF0A6CFF"))
        )
    }
    static var surfaceDefaultAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var surfaceDefaultAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var surfaceDefaultAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD633FF")),
            lightColor: Color(UIColor(hex: "#FFD429FF"))
        )
    }
    static var surfaceDefaultAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    }
    static var surfaceDefaultAccentHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F60424FF")),
            lightColor: Color(UIColor(hex: "#F60424FF"))
        )
    }
    ...
    static var surfaceDefaultAdditional: Self {
        Self(
            darkColor: Color(UIColor(hex: "#494F54FF")),
            lightColor: Color(UIColor(hex: "#D1DDE5FF"))
        )
    }
    static var surfaceDefaultAdditionalActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#454A4FFF")),
            lightColor: Color(UIColor(hex: "#C4D4DEFF"))
        )
    }
    static var surfaceDefaultAdditionalHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#535A5FFF")),
            lightColor: Color(UIColor(hex: "#DEE7EDFF"))
        )
    }
    ...
    static var surfaceDefaultSolidCard: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15181AFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    static var surfaceDefaultSolidCardActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#101214FF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    static var surfaceDefaultSolidCardHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#191D1FFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
    }
    ...
    static var surfaceDefaultSolidSecondary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#24282BFF")),
            lightColor: Color(UIColor(hex: "#F2F5F7FF"))
        )
    }
    static var surfaceDefaultSolidSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#1E2224FF")),
            lightColor: Color(UIColor(hex: "#ECF0F3FF"))
        )
    }
    static var surfaceDefaultSolidSecondaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#2C3135FF")),
            lightColor: Color(UIColor(hex: "#F9FAFBFF"))
        )
    }
    static var surfaceDefaultSolidTertiary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#31373BFF")),
            lightColor: Color(UIColor(hex: "#E4EBF0FF"))
        )
    }
    ...
    static var surfaceDefaultSolidTertiaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3A4145FF")),
            lightColor: Color(UIColor(hex: "#F2F5F8FF"))
        )
    }
    ...
    static var surfaceOnDarkAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0DA8AB")),
            lightColor: Color(UIColor(hex: "#0DA8AB"))
        )
    }
    static var surfaceOnDarkAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C9FA1FF")),
            lightColor: Color(UIColor(hex: "#0B9598FF"))
        )
    }
    static var surfaceOnDarkAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0EBBBEFF")),
            lightColor: Color(UIColor(hex: "#0EBBBEFF"))
        )
    }
    static var surfaceOnDarkAccentBlue: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5993FFFF")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceOnDarkAccentBlueActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#4D8BFFFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceOnDarkAccentBlueHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#75A5FFFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceOnDarkAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var surfaceOnDarkAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1472FF")),
            lightColor: Color(UIColor(hex: "#FF0A6CFF"))
        )
    }
    static var surfaceOnDarkAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var surfaceOnDarkAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var surfaceOnDarkAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD633FF")),
            lightColor: Color(UIColor(hex: "#FFD429FF"))
        )
    }
    static var surfaceOnDarkAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    ...
    static var surfaceOnDarkAdditional: Self {
        Self(
            darkColor: Color(UIColor(hex: "#494F54FF")),
            lightColor: Color(UIColor(hex: "#494F54FF"))
        )
    }
    static var surfaceOnDarkAdditionalActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#454A4FFF")),
            lightColor: Color(UIColor(hex: "#40454AFF"))
        )
    }
    static var surfaceOnDarkAdditionalHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#535A5FFF")),
            lightColor: Color(UIColor(hex: "#5C646AFF"))
        )
    }
    ...
    static var surfaceOnDarkNegative: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF2E43FF")),
            lightColor: Color(UIColor(hex: "#FF2E43FF"))
        )
    }
    static var surfaceOnDarkNegativeActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF243AFF")),
            lightColor: Color(UIColor(hex: "#FF1A30FF"))
        )
    }
    static var surfaceOnDarkNegativeHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF4D5EFF")),
            lightColor: Color(UIColor(hex: "#FF5768FF"))
        )
    }
    ...
    static var surfaceOnDarkSolidCard: Self {
        Self(
            darkColor: Color(UIColor(hex: "#15181AFF")),
            lightColor: Color(UIColor(hex: "#15181AFF"))
        )
    }
    static var surfaceOnDarkSolidCardActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#101214FF")),
            lightColor: Color(UIColor(hex: "#0B0D0EFF"))
        )
    }
    static var surfaceOnDarkSolidCardHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#191D1FFF")),
            lightColor: Color(UIColor(hex: "#22272AFF"))
        )
    }
    ...
    static var surfaceOnLightAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0DA8AB")),
            lightColor: Color(UIColor(hex: "#0DA8AB"))
        )
    }
    static var surfaceOnLightAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C9FA1FF")),
            lightColor: Color(UIColor(hex: "#0B9598FF"))
        )
    }
    static var surfaceOnLightAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0EBBBEFF")),
            lightColor: Color(UIColor(hex: "#0EBBBEFF"))
        )
    }
    static var surfaceOnLightAccentBlue: Self {
        Self(
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
    }
    static var surfaceOnLightAccentBlueActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
    }
    static var surfaceOnLightAccentBlueHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
    }
    static var surfaceOnLightAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var surfaceOnLightAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1472FF")),
            lightColor: Color(UIColor(hex: "#FF0A6CFF"))
        )
    }
    static var surfaceOnLightAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var surfaceOnLightAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var surfaceOnLightAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD633FF")),
            lightColor: Color(UIColor(hex: "#FFD429FF"))
        )
    }
    static var surfaceOnLightAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    ...
    static var surfaceOnLightAdditional: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D1DDE5FF")),
            lightColor: Color(UIColor(hex: "#D1DDE5FF"))
        )
    }
    static var surfaceOnLightAdditionalActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#CBD8E2FF")),
            lightColor: Color(UIColor(hex: "#C4D4DEFF"))
        )
    }
    static var surfaceOnLightAdditionalHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#DEE7EDFF")),
            lightColor: Color(UIColor(hex: "#DEE7EDFF"))
        )
    }
    ...
    static var surfaceOnLightSolidSecondary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F7FF")),
            lightColor: Color(UIColor(hex: "#F2F5F7FF"))
        )
    }
    static var surfaceOnLightSolidSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#ECF0F3FF")),
            lightColor: Color(UIColor(hex: "#ECF0F3FF"))
        )
    }
    static var surfaceOnLightSolidSecondaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F9FAFBFF")),
            lightColor: Color(UIColor(hex: "#F9FAFBFF"))
        )
    }
    static var surfaceOnLightSolidTertiary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#E4EBF0FF")),
            lightColor: Color(UIColor(hex: "#E4EBF0FF"))
        )
    }
    ...
    static var surfaceOnLightSolidTertiaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F8FF")),
            lightColor: Color(UIColor(hex: "#F2F5F8FF"))
        )
    }
    ...
    static var textDefaultAccentActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#C4031DFF")),
            lightColor: Color(UIColor(hex: "#BA031BFF"))
        )
    }
    static var textDefaultAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#04C6C9")),
            lightColor: Color(UIColor(hex: "#0C8688"))
        )
    }
    static var textDefaultAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#03A7AAFF")),
            lightColor: Color(UIColor(hex: "#0FABAEFF"))
        )
    }
    static var textDefaultAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23F7FBFF")),
            lightColor: Color(UIColor(hex: "#12D0D3FF"))
        )
    }
    static var textDefaultAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var textDefaultAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF0066FF")),
            lightColor: Color(UIColor(hex: "#F50062FF"))
        )
    }
    static var textDefaultAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var textDefaultAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var textDefaultAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD21FFF")),
            lightColor: Color(UIColor(hex: "#FFD014FF"))
        )
    }
    static var textDefaultAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    ...
    static var textDefaultAccentHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FB0929FF")),
            lightColor: Color(UIColor(hex: "#FB1332FF"))
        )
    }
    ...
    static var textDefaultNegativeActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF0F27FF")),
    ...
    static var textDefaultParagraph: Self {
        Self(
            darkColor: Color(UIColor(hex: "#BEC9D1FF")),
            lightColor: Color(UIColor(hex: "#24282BFF"))
        )
    }
    static var textDefaultParagraphActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#262F36FF")),
            lightColor: Color(UIColor(hex: "#485056FF"))
        )
    }
    static var textDefaultParagraphHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#6D7983FF"))
        )
    }
    ...
    static var textDefaultPrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#D3DDE4FF")),
            lightColor: Color(UIColor(hex: "#485056FF"))
        )
    }
    static var textDefaultPrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#B3C5D0FF")),
            lightColor: Color(UIColor(hex: "#6D7983FF"))
        )
    }
    ...
    static var textDefaultSecondary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A8B4BDFF")),
            lightColor: Color(UIColor(hex: "#8C959CFF"))
        )
    }
    static var textDefaultSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#353E46FF")),
            lightColor: Color(UIColor(hex: "#6D767EFF"))
        )
    }
    ...
    static var textDefaultTertiary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#7D868CFF")),
            lightColor: Color(UIColor(hex: "#BEC9D1FF"))
        )
    }
    static var textDefaultTertiaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#5B6267FF")),
            lightColor: Color(UIColor(hex: "#8EA1AFFF"))
        )
    }
    ...
    static var textInversePrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#A6AEB5FF")),
            lightColor: Color(UIColor(hex: "#B6C7D2FF"))
        )
    }
    ...
    static var textOnDarkAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#04C6C9")),
            lightColor: Color(UIColor(hex: "#04C6C9"))
        )
    }
    static var textOnDarkAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#03A7AAFF")),
            lightColor: Color(UIColor(hex: "#039DA0FF"))
        )
    }
    static var textOnDarkAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#23F7FBFF")),
            lightColor: Color(UIColor(hex: "#05ECF0FF"))
        )
    }
    static var textOnDarkAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var textOnDarkAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF0066FF")),
            lightColor: Color(UIColor(hex: "#F50062FF"))
        )
    }
    static var textOnDarkAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var textOnDarkAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var textOnDarkAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD21FFF")),
            lightColor: Color(UIColor(hex: "#FFD014FF"))
        )
    }
    static var textOnDarkAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    ...
    static var textOnDarkNegativeActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF0F27FF")),
            lightColor: Color(UIColor(hex: "#FF051EFF"))
        )
    }
    ...
    static var textOnDarkParagraph: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F7CC")),
            lightColor: Color(UIColor(hex: "#F2F5F7CC"))
        )
    }
    static var textOnDarkParagraphActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F7A3")),
            lightColor: Color(UIColor(hex: "#F2F5F7A3"))
        )
    }
    static var textOnDarkParagraphHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F77A")),
            lightColor: Color(UIColor(hex: "#F2F5F77A"))
        )
    }
    ...
    static var textOnDarkPrimary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F7F5")),
            lightColor: Color(UIColor(hex: "#F2F5F7F5"))
        )
    }
    static var textOnDarkPrimaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F7C4")),
            lightColor: Color(UIColor(hex: "#F2F5F7C4"))
        )
    }
    static var textOnDarkPrimaryHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F793")),
            lightColor: Color(UIColor(hex: "#F2F5F793"))
        )
    }
    ...
    static var textOnDarkTertiary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#F2F5F766")),
            lightColor: Color(UIColor(hex: "#F2F5F766"))
        )
    }
    ...
    static var textOnLightAccentB2B: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0C8688")),
            lightColor: Color(UIColor(hex: "#0C8688"))
        )
    }
    static var textOnLightAccentB2BActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#0EA2A4FF")),
            lightColor: Color(UIColor(hex: "#0FABAEFF"))
        )
    }
    static var textOnLightAccentB2BHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#11BDC0FF")),
            lightColor: Color(UIColor(hex: "#12D0D3FF"))
        )
    }
    static var textOnLightAccentDiscount: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF1F78")),
            lightColor: Color(UIColor(hex: "#FF1F78"))
        )
    }
    static var textOnLightAccentDiscountActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF0066FF")),
            lightColor: Color(UIColor(hex: "#F50062FF"))
        )
    }
    static var textOnLightAccentDiscountHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FF3D8BFF")),
            lightColor: Color(UIColor(hex: "#FF4791FF"))
        )
    }
    static var textOnLightAccentGold: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD83D")),
            lightColor: Color(UIColor(hex: "#FFD83D"))
        )
    }
    static var textOnLightAccentGoldActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFD21FFF")),
            lightColor: Color(UIColor(hex: "#FFD014FF"))
        )
    }
    static var textOnLightAccentGoldHover: Self {
        Self(
            darkColor: Color(UIColor(hex: "#FFDE5CFF")),
            lightColor: Color(UIColor(hex: "#FFE066FF"))
        )
    ...
    static var textOnLightSecondary: Self {
        Self(
            darkColor: Color(UIColor(hex: "#8C959CFF")),
            lightColor: Color(UIColor(hex: "#8C959CFF"))
        )
    }
    static var textOnLightSecondaryActive: Self {
        Self(
            darkColor: Color(UIColor(hex: "#51585DFF")),
            lightColor: Color(UIColor(hex: "#6D767EFF"))
        )
    }

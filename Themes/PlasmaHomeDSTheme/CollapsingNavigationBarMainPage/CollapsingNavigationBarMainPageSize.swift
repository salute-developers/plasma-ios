...
struct CollapsingNavigationBarMainPageSize {
    static let `default` = CollapsingNavigationBarMainPageSizeDefault()

    static let all: [CollapsingNavigationBarSizeConfiguration] = [
        CollapsingNavigationBarMainPageSize.`default`,
    ]
}

struct CollapsingNavigationBarMainPageSizeDefault: CollapsingNavigationBarSizeConfiguration {
    ...
    public var debugDescription: String {
        return "CollapsingNavigationBarMainPageSize"
    }
}

struct CollapsingNavigationBarMainPageAnySize: CollapsingNavigationBarSizeConfiguration {
    var backIconMargin = CGFloat(0)
    ...
    var debugDescription: String {
        return "CollapsingNavigationBarMainPageAnySize"
    }
}

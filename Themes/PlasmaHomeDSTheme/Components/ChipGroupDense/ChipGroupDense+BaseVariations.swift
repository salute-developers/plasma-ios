...
public struct ChipGroupDense {
    ...
    public static var xxs: GeneralAppearanceVariation<ChipGroupDense, ChipGroupAppearance, ChipGroupDenseVariation.Xxs> {
        var appearance = ChipGroupAppearance.base
        appearance.size = ChipGroupDenseSize.xxs
    ...
    public static let all: [Variation<ChipGroupAppearance>] = [
        ...
        ChipGroupDense.xxs.variation,
        ChipGroupDense.xxs.pilled.variation,
    ]
}

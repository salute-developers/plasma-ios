...
public struct Editable {
    ...
    public static var h6: ComponentAppearanceVariation<Editable, EditableAppearance> {
        var appearance = EditableAppearance.base
        appearance.size = EditableSize.h6
        appearance.textTypography = EditableTypography(oneSize: AdaptiveTypographyToken.headerH6Bold.typography).asContainer

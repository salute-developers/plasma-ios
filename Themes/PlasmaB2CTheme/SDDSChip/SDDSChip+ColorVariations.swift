...
public struct SDDSChip {
    public static var accent: AppearanceVariation<ChipAppearance> {
        .init(
            name: "accent",
            appearance: .init(
    ...
    public static var `default`: AppearanceVariation<ChipAppearance> {
        .init(
            name: "default",
            appearance: .init(
    ...
    public static var negative: AppearanceVariation<ChipAppearance> {
        .init(
            name: "negative",
            appearance: .init(
                titleColor: ColorToken.textOnDarkPrimary,
    ...
    public static var positive: AppearanceVariation<ChipAppearance> {
        .init(
            name: "positive",
            appearance: .init(
                titleColor: ColorToken.textOnDarkPrimary,
    ...
    public static var secondary: AppearanceVariation<ChipAppearance> {
        .init(
            name: "secondary",
            appearance: .init(
    ...
    public static var warning: AppearanceVariation<ChipAppearance> {
        .init(
            name: "warning",
            appearance: .init(
                titleColor: ColorToken.textOnDarkPrimary,
    ...
    public static var all: [AppearanceVariation<ChipAppearance>] {
        [

...
public extension ColorToken {
    ...
    static var backgroundDarkPrimary: Self {
        ...
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var backgroundDefaultPrimaryBrightness: Self {
        let base = Self(
            id: Colors.backgroundDefaultPrimaryBrightness.rawValue,
    ...
    static var backgroundInversePrimaryBrightness: Self {
        let base = Self(
            id: Colors.backgroundInversePrimaryBrightness.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#0F0F0FFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var dataDefaultYellowActive: Self {
        let base = Self(
            id: Colors.dataDefaultYellowActive.rawValue,
    ...
    static var dataDefaultYellowHover: Self {
        let base = Self(
            id: Colors.dataDefaultYellowHover.rawValue,
    ...
    static var dataDefaultYellowMinorActive: Self {
        let base = Self(
            id: Colors.dataDefaultYellowMinorActive.rawValue,
    ...
    static var dataDefaultYellowMinorHover: Self {
        let base = Self(
            id: Colors.dataDefaultYellowMinorHover.rawValue,
    ...
    static var dataDefaultYellowTransparentActive: Self {
        let base = Self(
            id: Colors.dataDefaultYellowTransparentActive.rawValue,
    ...
    static var dataDefaultYellowTransparentHover: Self {
        let base = Self(
            id: Colors.dataDefaultYellowTransparentHover.rawValue,
    ...
    static var dataInverseYellowActive: Self {
        let base = Self(
            id: Colors.dataInverseYellowActive.rawValue,
            darkColor: Color(UIColor(hex: "#EDA20CFF")),
            lightColor: Color(UIColor(hex: "#E49C0CFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataInverseYellowHover: Self {
        let base = Self(
            id: Colors.dataInverseYellowHover.rawValue,
            darkColor: Color(UIColor(hex: "#F4B22FFF")),
            lightColor: Color(UIColor(hex: "#F5B638FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataInverseYellowMinorActive: Self {
        let base = Self(
            id: Colors.dataInverseYellowMinorActive.rawValue,
    ...
    static var dataInverseYellowMinorHover: Self {
        let base = Self(
            id: Colors.dataInverseYellowMinorHover.rawValue,
    ...
    static var dataInverseYellowTransparentActive: Self {
        let base = Self(
            id: Colors.dataInverseYellowTransparentActive.rawValue,
            darkColor: Color(UIColor(hex: "#F3A81280")),
            lightColor: Color(UIColor(hex: "#F3A81299"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataInverseYellowTransparentHover: Self {
        let base = Self(
            id: Colors.dataInverseYellowTransparentHover.rawValue,
            darkColor: Color(UIColor(hex: "#F3A812AD")),
            lightColor: Color(UIColor(hex: "#F3A8127A"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowActive: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowActive.rawValue,
            darkColor: Color(UIColor(hex: "#EDA20CFF")),
            lightColor: Color(UIColor(hex: "#E49C0CFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowHover: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowHover.rawValue,
            darkColor: Color(UIColor(hex: "#F4B22FFF")),
            lightColor: Color(UIColor(hex: "#F5B638FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowMinorActive: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowMinorActive.rawValue,
            darkColor: Color(UIColor(hex: "#996600FF")),
            lightColor: Color(UIColor(hex: "#8F5F00FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowMinorHover: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowMinorHover.rawValue,
            darkColor: Color(UIColor(hex: "#B87A00FF")),
            lightColor: Color(UIColor(hex: "#B87A00FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowTransparentActive: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowTransparentActive.rawValue,
            darkColor: Color(UIColor(hex: "#F3A81280")),
            lightColor: Color(UIColor(hex: "#F3A81299"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnDarkYellowTransparentHover: Self {
        let base = Self(
            id: Colors.dataOnDarkYellowTransparentHover.rawValue,
            darkColor: Color(UIColor(hex: "#F3A812AD")),
            lightColor: Color(UIColor(hex: "#F3A8127A"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowActive: Self {
        let base = Self(
            id: Colors.dataOnLightYellowActive.rawValue,
            darkColor: Color(UIColor(hex: "#EDA20CFF")),
            lightColor: Color(UIColor(hex: "#E49C0CFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowHover: Self {
        let base = Self(
            id: Colors.dataOnLightYellowHover.rawValue,
            darkColor: Color(UIColor(hex: "#F4B22FFF")),
            lightColor: Color(UIColor(hex: "#F5B638FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowMinorActive: Self {
        let base = Self(
            id: Colors.dataOnLightYellowMinorActive.rawValue,
            darkColor: Color(UIColor(hex: "#FFCF70FF")),
            lightColor: Color(UIColor(hex: "#FFCC66FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowMinorHover: Self {
        let base = Self(
            id: Colors.dataOnLightYellowMinorHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFDA8FFF")),
            lightColor: Color(UIColor(hex: "#FFDA8FFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowTransparentActive: Self {
        let base = Self(
            id: Colors.dataOnLightYellowTransparentActive.rawValue,
            darkColor: Color(UIColor(hex: "#F3A81280")),
            lightColor: Color(UIColor(hex: "#F3A81299"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var dataOnLightYellowTransparentHover: Self {
        let base = Self(
            id: Colors.dataOnLightYellowTransparentHover.rawValue,
            darkColor: Color(UIColor(hex: "#F3A812AD")),
            lightColor: Color(UIColor(hex: "#F3A8127A"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineDefaultAccent: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#2A72F8"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultAccentActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#1665F8FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultAccentHover: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#528DFAFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultAccentMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1446A3FF")),
            lightColor: Color(UIColor(hex: "#79A7FCFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultAccentMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1852BFFF")),
            lightColor: Color(UIColor(hex: "#A1C1FDFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineDefaultDefaultActive: Self {
        let base = Self(
            id: Colors.outlineDefaultDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#F5F5F5FF")),
    ...
    static var outlineDefaultDefaultHover: Self {
        let base = Self(
            id: Colors.outlineDefaultDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
    ...
    static var outlineDefaultInfoActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#4788FFFF")),
    ...
    static var outlineDefaultInfoHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#70A2FFFF")),
    ...
    static var outlineDefaultNegativeActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FF3347FF")),
    ...
    static var outlineDefaultNegativeMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#951320FF")),
            lightColor: Color(UIColor(hex: "#FF7A88FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultNegativeMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#B01726FF")),
            lightColor: Color(UIColor(hex: "#FFA3ACFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultNegativeTransparentActive: Self {
        let base = Self(
            id: Colors.outlineDefaultNegativeTransparentActive.rawValue,
    ...
    static var outlineDefaultNegativeTransparentHover: Self {
        let base = Self(
            id: Colors.outlineDefaultNegativeTransparentHover.rawValue,
    ...
    static var outlineDefaultPositiveMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#085416FF")),
            lightColor: Color(UIColor(hex: "#25C141FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultPositiveMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#0B6F1DFF")),
            lightColor: Color(UIColor(hex: "#36D954FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultPrimaryActive: Self {
        let base = Self(
            id: Colors.outlineDefaultPrimaryActive.rawValue,
    ...
    static var outlineDefaultPrimaryHover: Self {
        let base = Self(
            id: Colors.outlineDefaultPrimaryHover.rawValue,
    ...
    static var outlineDefaultSecondaryActive: Self {
        let base = Self(
            id: Colors.outlineDefaultSecondaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#4A4A4AFF")),
            lightColor: Color(UIColor(hex: "#8A8A8AFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultSecondaryHover: Self {
        let base = Self(
            id: Colors.outlineDefaultSecondaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#595959FF")),
            lightColor: Color(UIColor(hex: "#A3A3A3FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTertiaryActive: Self {
        let base = Self(
            id: Colors.outlineDefaultTertiaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#6B6B6BFF")),
            lightColor: Color(UIColor(hex: "#666666FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTertiaryHover: Self {
        let base = Self(
            id: Colors.outlineDefaultTertiaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#7A7A7AFF")),
            lightColor: Color(UIColor(hex: "#858585FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTransparentAccent: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#3F81FD47")),
            lightColor: Color(UIColor(hex: "#2A72F833"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTransparentAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#3F82FD38")),
            lightColor: Color(UIColor(hex: "#2A72F83D"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTransparentAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#3F82FD66")),
            lightColor: Color(UIColor(hex: "#2A72F81F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineDefaultTransparentClear: Self {
        let base = Self(
            id: Colors.outlineDefaultTransparentClear.rawValue,
    ...
    static var outlineDefaultTransparentClearActive: Self {
        let base = Self(
            id: Colors.outlineDefaultTransparentClearActive.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFF00")),
            lightColor: Color(UIColor(hex: "#FFFFFF00"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineDefaultTransparentClearHover: Self {
        let base = Self(
            id: Colors.outlineDefaultTransparentClearHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFF00")),
            lightColor: Color(UIColor(hex: "#FFFFFF00"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineDefaultTransparentNegativeActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F31B3124")),
    ...
    static var outlineDefaultTransparentNegativeHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F31B3152")),
            lightColor: Color(UIColor(hex: "#F31B311F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultTransparentPositive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1A9E3247")),
    ...
    static var outlineDefaultTransparentPositiveActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1A9E3238")),
    ...
    static var outlineDefaultTransparentPositiveHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1A9E3266")),
    ...
    static var outlineDefaultTransparentTertiaryActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FFFFFF57")),
    ...
    static var outlineDefaultTransparentTertiaryHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FFFFFF85")),
    ...
    static var outlineDefaultTransparentWarning: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FA5F0547")),
    ...
    static var outlineDefaultTransparentWarningActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FA5F0538")),
    ...
    static var outlineDefaultTransparentWarningHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FA5F0566")),
    ...
    static var outlineDefaultWarningActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FF6A1AFF")),
    ...
    static var outlineDefaultWarningMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#79340BFF")),
            lightColor: Color(UIColor(hex: "#FC8F54FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineDefaultWarningMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#95400EFF")),
            lightColor: Color(UIColor(hex: "#FDA97CFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseAccent: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F8")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#0D5FF8FF")),
    ...
    static var outlineInverseAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#79A7FBFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseDefaultActive: Self {
        let base = Self(
            id: Colors.outlineInverseDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#C7C7C7FF")),
    ...
    static var outlineInverseDefaultHover: Self {
        let base = Self(
            id: Colors.outlineInverseDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInversePrimaryActive: Self {
        let base = Self(
            id: Colors.outlineInversePrimaryActive.rawValue,
    ...
    static var outlineInversePrimaryHover: Self {
        let base = Self(
            id: Colors.outlineInversePrimaryHover.rawValue,
    ...
    static var outlineInverseSecondaryActive: Self {
        let base = Self(
            id: Colors.outlineInverseSecondaryActive.rawValue,
    ...
    static var outlineInverseSecondaryHover: Self {
        let base = Self(
            id: Colors.outlineInverseSecondaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTertiaryActive: Self {
        let base = Self(
            id: Colors.outlineInverseTertiaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#737373FF")),
            lightColor: Color(UIColor(hex: "#595959FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTertiaryHover: Self {
        let base = Self(
            id: Colors.outlineInverseTertiaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTransparentAccent: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F833")),
            lightColor: Color(UIColor(hex: "#3F81FD47"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F83D")),
            lightColor: Color(UIColor(hex: "#3F82FD56"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F8FF")),
    ...
    static var outlineInverseTransparentClear: Self {
        let base = Self(
            id: Colors.outlineInverseTransparentClear.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFF00")),
            lightColor: Color(UIColor(hex: "#FFFFFF00"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTransparentClearActive: Self {
        let base = Self(
            id: Colors.outlineInverseTransparentClearActive.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTransparentClearHover: Self {
        let base = Self(
            id: Colors.outlineInverseTransparentClearHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineInverseTransparentNegative: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F31B3133")),
            lightColor: Color(UIColor(hex: "#FF293E47"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentNegativeActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#FF293E56"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentPositive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#1A9E3247"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentPositiveActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#1A9E3256"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentWarning: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#FA5F0547"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineInverseTransparentWarningActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#FA5F0556"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkAccentMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1446A3FF")),
            lightColor: Color(UIColor(hex: "#13429AFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkAccentMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1852BFFF")),
            lightColor: Color(UIColor(hex: "#1956C8FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineOnDarkDefaultActive: Self {
        let base = Self(
            id: Colors.outlineOnDarkDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#F5F5F5FF")),
            lightColor: Color(UIColor(hex: "#F5F5F5FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineOnDarkDefaultHover: Self {
        let base = Self(
            id: Colors.outlineOnDarkDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnDarkInfoActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#4788FFFF")),
            lightColor: Color(UIColor(hex: "#3D81FFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkNegativeMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#951320FF")),
            lightColor: Color(UIColor(hex: "#8C121EFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkNegativeMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#B01726FF")),
            lightColor: Color(UIColor(hex: "#B91828FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineOnDarkNegativeTransparent: Self {
        let base = Self(
            id: Colors.outlineOnDarkNegativeTransparent.rawValue,
            darkColor: Color(UIColor(hex: "#FF293E47")),
            lightColor: Color(UIColor(hex: "#FF293E47"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkNegativeTransparentActive: Self {
        let base = Self(
            id: Colors.outlineOnDarkNegativeTransparentActive.rawValue,
            darkColor: Color(UIColor(hex: "#FF293E38")),
            lightColor: Color(UIColor(hex: "#FF293E52"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }


    static var outlineOnDarkNegativeTransparentHover: Self {
        let base = Self(
            id: Colors.outlineOnDarkNegativeTransparentHover.rawValue,
            darkColor: Color(UIColor(hex: "#FF293E66")),
    ...
    static var outlineOnDarkPositiveMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#085416FF")),
            lightColor: Color(UIColor(hex: "#70300AFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkPositiveMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#0B6F1DFF")),
            lightColor: Color(UIColor(hex: "#95400EFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkPrimaryActive: Self {
        let base = Self(
            id: Colors.outlineOnDarkPrimaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#212121FF")),
    ...
    static var outlineOnDarkPrimaryHover: Self {
        let base = Self(
            id: Colors.outlineOnDarkPrimaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#303030FF")),
    ...
    static var outlineOnDarkSecondaryActive: Self {
        let base = Self(
            id: Colors.outlineOnDarkSecondaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#4A4A4AFF")),
    ...
    static var outlineOnDarkSecondaryHover: Self {
        let base = Self(
            id: Colors.outlineOnDarkSecondaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#595959FF")),
    ...
    static var outlineOnDarkTertiaryActive: Self {
        let base = Self(
            id: Colors.outlineOnDarkTertiaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#6B6B6BFF")),
            lightColor: Color(UIColor(hex: "#666666FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnDarkTertiaryHover: Self {
        let base = Self(
            id: Colors.outlineOnDarkTertiaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#7A7A7AFF")),
            lightColor: Color(UIColor(hex: "#858585FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnDarkTransparentAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#3F82FD38")),
            lightColor: Color(UIColor(hex: "#3F82FD52"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkTransparentAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#3F82FD66")),
            lightColor: Color(UIColor(hex: "#3F82FD33"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkTransparentPositiveActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#1A9E3238")),
            lightColor: Color(UIColor(hex: "#1A9E3252"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkTransparentTertiaryActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FFFFFF57")),
            lightColor: Color(UIColor(hex: "#FFFFFF70"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkTransparentWarningActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FA5F0538")),
            lightColor: Color(UIColor(hex: "#FA5F0552"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnDarkWarningActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FF6A1AFF")),
            lightColor: Color(UIColor(hex: "#FF630FFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#206CF8FF")),
            lightColor: Color(UIColor(hex: "#1665F8FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#4886F9FF")),
            lightColor: Color(UIColor(hex: "#528DFAFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightAccentMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#83ADFCFF")),
            lightColor: Color(UIColor(hex: "#79A7FCFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightAccentMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#A1C1FDFF")),
            lightColor: Color(UIColor(hex: "#A1C1FDFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightDefaultActive: Self {
        let base = Self(
            id: Colors.outlineOnLightDefaultActive.rawValue,
    ...
    static var outlineOnLightDefaultHover: Self {
        let base = Self(
            id: Colors.outlineOnLightDefaultHover.rawValue,
    ...
    static var outlineOnLightNegativeMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FF8591FF")),
            lightColor: Color(UIColor(hex: "#FF7A88FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightNegativeMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FFA3ACFF")),
            lightColor: Color(UIColor(hex: "#FFA3ACFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightNegativeTransparent: Self {
        let base = Self(
            id: Colors.outlineOnLightNegativeTransparent.rawValue,
            darkColor: Color(UIColor(hex: "#F31B3133")),
            lightColor: Color(UIColor(hex: "#F31B3133"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnLightNegativeTransparentActive: Self {
        let base = Self(
            id: Colors.outlineOnLightNegativeTransparentActive.rawValue,
            darkColor: Color(UIColor(hex: "#F31B3124")),
            lightColor: Color(UIColor(hex: "#F31B313D"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnLightNegativeTransparentHover: Self {
        let base = Self(
            id: Colors.outlineOnLightNegativeTransparentHover.rawValue,
            darkColor: Color(UIColor(hex: "#F31B3152")),
            lightColor: Color(UIColor(hex: "#F31B311F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnLightPositiveMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#26C944FF")),
            lightColor: Color(UIColor(hex: "#25C141FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightPositiveMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#36D954FF")),
            lightColor: Color(UIColor(hex: "#36D954FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightPrimaryActive: Self {
        let base = Self(
            id: Colors.outlineOnLightPrimaryActive.rawValue,
    ...
    static var outlineOnLightPrimaryHover: Self {
        let base = Self(
            id: Colors.outlineOnLightPrimaryHover.rawValue,
    ...
    static var outlineOnLightSecondaryActive: Self {
        let base = Self(
            id: Colors.outlineOnLightSecondaryActive.rawValue,
    ...
    static var outlineOnLightSecondaryHover: Self {
        let base = Self(
            id: Colors.outlineOnLightSecondaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#9E9E9EFF")),
            lightColor: Color(UIColor(hex: "#A3A3A3FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTertiaryActive: Self {
        let base = Self(
            id: Colors.outlineOnLightTertiaryActive.rawValue,
            darkColor: Color(UIColor(hex: "#6B6B6BFF")),
            lightColor: Color(UIColor(hex: "#666666FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnLightTertiaryHover: Self {
        let base = Self(
            id: Colors.outlineOnLightTertiaryHover.rawValue,
            darkColor: Color(UIColor(hex: "#7A7A7AFF")),
            lightColor: Color(UIColor(hex: "#858585FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var outlineOnLightTransparentAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F824")),
            lightColor: Color(UIColor(hex: "#2A72F83D"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentAccentHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F852")),
            lightColor: Color(UIColor(hex: "#2A72F81F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentPrimaryActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#08080824")),
            lightColor: Color(UIColor(hex: "#0808083D"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentPrimaryHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#08080852")),
            lightColor: Color(UIColor(hex: "#0808081F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentSecondaryActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#08080857")),
            lightColor: Color(UIColor(hex: "#08080870"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentSecondaryHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#08080885")),
            lightColor: Color(UIColor(hex: "#08080852"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightTransparentWarningActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#E8570224")),
    ...
    static var outlineOnLightTransparentWarningHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#E8570252")),
            lightColor: Color(UIColor(hex: "#E857021F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightWarningMinorActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FD965EFF")),
            lightColor: Color(UIColor(hex: "#FC8F54FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var outlineOnLightWarningMinorHover: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#FDA97CFF")),
            lightColor: Color(UIColor(hex: "#FDA97CFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var overlayInverseBlur: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F9F9F947")),
    ...
    static var overlayInverseHard: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F9F9F9F5")),
    ...
    static var overlayInverseSoft: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F9F9F98F")),
            lightColor: Color(UIColor(hex: "#0808088F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceDefaultTransparentAccentActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#2A72F829"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceDefaultTransparentAccentHover: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#2A72F80A"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceDefaultTransparentDefault: Self {
        let base = Self(
            id: Colors.surfaceDefaultTransparentDefault.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#080808"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceDefaultTransparentDefaultActive: Self {
        let base = Self(
            id: Colors.surfaceDefaultTransparentDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#030303FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceDefaultTransparentDefaultHover: Self {
        let base = Self(
            id: Colors.surfaceDefaultTransparentDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#262626FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceInverseTransparentAccent: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F81F")),
            lightColor: Color(UIColor(hex: "#2A72F81F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceInverseTransparentAccentActive: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#2A72F80F")),
            lightColor: Color(UIColor(hex: "#2A72F829"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceInverseTransparentDefault: Self {
        let base = Self(
            id: Colors.surfaceInverseTransparentDefault.rawValue,
            darkColor: Color(UIColor(hex: "#080808")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceInverseTransparentDefaultActive: Self {
        let base = Self(
            id: Colors.surfaceInverseTransparentDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#030303FF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceInverseTransparentDefaultHover: Self {
        let base = Self(
            id: Colors.surfaceInverseTransparentDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#0D0D0DFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceInverseTransparentNegative: Self {
        let base = Self(
            ...
            darkColor: Color(UIColor(hex: "#F31B311F")),
            lightColor: Color(UIColor(hex: "#F31B311F"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }
    ...
    static var surfaceOnDarkSurfaceInfo: Self {
        let base = Self(
            id: Colors.surfaceOnDarkSurfaceInfo.rawValue,
            darkColor: Color(UIColor(hex: "#3F81FD")),
            lightColor: Color(UIColor(hex: "#3F81FD"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnDarkSurfaceInfoActive: Self {
        let base = Self(
            id: Colors.surfaceOnDarkSurfaceInfoActive.rawValue,
            darkColor: Color(UIColor(hex: "#357BFDFF")),
            lightColor: Color(UIColor(hex: "#2B74FDFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnDarkSurfaceInfoHover: Self {
        let base = Self(
            id: Colors.surfaceOnDarkSurfaceInfoHover.rawValue,
            darkColor: Color(UIColor(hex: "#5D95FDFF")),
            lightColor: Color(UIColor(hex: "#689CFDFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnDarkTransparentDefault: Self {
        let base = Self(
            id: Colors.surfaceOnDarkTransparentDefault.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnDarkTransparentDefaultActive: Self {
        let base = Self(
            id: Colors.surfaceOnDarkTransparentDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnDarkTransparentDefaultHover: Self {
        let base = Self(
            id: Colors.surfaceOnDarkTransparentDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#FFFFFFFF")),
            lightColor: Color(UIColor(hex: "#FFFFFFFF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnLightTransparentDefault: Self {
        let base = Self(
            id: Colors.surfaceOnLightTransparentDefault.rawValue,
            darkColor: Color(UIColor(hex: "#080808")),
            lightColor: Color(UIColor(hex: "#080808"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnLightTransparentDefaultActive: Self {
        let base = Self(
            id: Colors.surfaceOnLightTransparentDefaultActive.rawValue,
            darkColor: Color(UIColor(hex: "#030303FF")),
            lightColor: Color(UIColor(hex: "#030303FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var surfaceOnLightTransparentDefaultHover: Self {
        let base = Self(
            id: Colors.surfaceOnLightTransparentDefaultHover.rawValue,
            darkColor: Color(UIColor(hex: "#0D0D0DFF")),
            lightColor: Color(UIColor(hex: "#262626FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    ...
    static var textDefaultAccentActive: Self {
        let base = Self(
            ...
            lightColor: Color(UIColor(hex: "#075AF2FF"))
        )
        return ThemeTenantRegistry.shared.resolveColor(theme: "PlasmaB2C", id: base.id, base: base)
    }

...
public struct IconButtonGroup {
    public static var l: GeneralAppearanceVariation<IconButtonGroup, ButtonGroupAppearance, IconButtonGroupVariation.L> {
    ...
    public static var m: GeneralAppearanceVariation<IconButtonGroup, ButtonGroupAppearance, IconButtonGroupVariation.M> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var s: GeneralAppearanceVariation<IconButtonGroup, ButtonGroupAppearance, IconButtonGroupVariation.S> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var xs: GeneralAppearanceVariation<IconButtonGroup, ButtonGroupAppearance, IconButtonGroupVariation.Xs> {
        var appearance = ButtonGroupAppearance.base

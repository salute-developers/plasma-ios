...
public struct BasicButtonGroup {
    public static var l: GeneralAppearanceVariation<BasicButtonGroup, ButtonGroupAppearance, BasicButtonGroupVariation.L> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var m: GeneralAppearanceVariation<BasicButtonGroup, ButtonGroupAppearance, BasicButtonGroupVariation.M> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var s: GeneralAppearanceVariation<BasicButtonGroup, ButtonGroupAppearance, BasicButtonGroupVariation.S> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var xs: GeneralAppearanceVariation<BasicButtonGroup, ButtonGroupAppearance, BasicButtonGroupVariation.Xs> {
        var appearance = ButtonGroupAppearance.base
    ...
    public static var xxs: GeneralAppearanceVariation<BasicButtonGroup, ButtonGroupAppearance, BasicButtonGroupVariation.Xxs> {
        var appearance = ButtonGroupAppearance.base
        appearance.size = BasicButtonGroupSize.xxs
    ...
    public static let all: [Variation<ButtonGroupAppearance>] = [
        ...
        BasicButtonGroup.xxs.variation,
        BasicButtonGroup.xxs.dense.variation,
        BasicButtonGroup.xxs.dense.default.variation,
        BasicButtonGroup.xxs.dense.segmented.variation,
        BasicButtonGroup.xxs.noGap.variation,
        BasicButtonGroup.xxs.noGap.default.variation,
        BasicButtonGroup.xxs.noGap.segmented.variation,
        BasicButtonGroup.xxs.wide.variation,
        BasicButtonGroup.xxs.wide.default.variation,
        BasicButtonGroup.xxs.wide.segmented.variation,
    ]
}
...
public struct BasicButtonGroupVariation {
    ...
    public struct Xxs {}
    public struct XxsDense {}
    public struct XxsDenseDefault {}
    public struct XxsDenseSegmented {}
    public struct XxsNogap {}
    public struct XxsNogapDefault {}
    public struct XxsNogapSegmented {}
    public struct XxsWide {}
    public struct XxsWideDefault {}
    public struct XxsWideSegmented {}
}

private extension ButtonGroupAppearance {
    static var base: ButtonGroupAppearance {

...
public extension GeneralAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance, SelectItemMultipleTightVariation.L> {
    
    var l: ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
        var size =  SelectItemMultipleTightAnySize(size: appearance.size)
...
public extension GeneralAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance, SelectItemMultipleTightVariation.M> {
    
    var m: ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
        var size =  SelectItemMultipleTightAnySize(size: appearance.size)
        size.controlMargin = CGFloat(6.0)
        size.controlSize = CGFloat(24.0)
...
public extension GeneralAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance, SelectItemMultipleTightVariation.S> {
    
    var s: ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
        var size =  SelectItemMultipleTightAnySize(size: appearance.size)
        size.controlMargin = CGFloat(6.0)
        size.controlSize = CGFloat(24.0)
...
public extension GeneralAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance, SelectItemMultipleTightVariation.Xl> {
    
    var xl: ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
        var size =  SelectItemMultipleTightAnySize(size: appearance.size)
...
public extension GeneralAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance, SelectItemMultipleTightVariation.Xs> {
    
    var xs: ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
        var size =  SelectItemMultipleTightAnySize(size: appearance.size)
...
public extension ComponentAppearanceVariation<SelectItemMultipleTight, SelectItemAppearance> {
    var variation: Variation<Appearance> {
        .init(
            originalVariation: self,
            styles: [

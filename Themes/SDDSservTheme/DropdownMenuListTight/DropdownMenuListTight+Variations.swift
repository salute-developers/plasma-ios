...
public extension GeneralAppearanceVariation<DropdownMenuListTight, ListAppearance, DropdownMenuListTightVariation.Xl> {
    
    var xl: ComponentAppearanceVariation<DropdownMenuListTight, ListAppearance> {
        var size =  DropdownMenuListTightAnySize(size: appearance.size)

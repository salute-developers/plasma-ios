...
private extension ButtonAppearance {
    ...
    var accent: ButtonAppearance {
        ...
        appearance.iconColor = StatefulFillStyle(defaultValue: .color(.textDefaultAccent), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultAccentActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultAccentHover))
        ])
        appearance.spinnerColor = StatefulFillStyle(defaultValue: .color(.textDefaultAccent), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultAccentActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultAccentHover))
        ])
        appearance.titleColor = StatefulFillStyle(defaultValue: .color(.textDefaultAccent), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultAccentActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultAccentHover))
        ])
        return appearance
    ...
    var info: ButtonAppearance {
        var appearance = self
        appearance.iconColor = StatefulFillStyle(defaultValue: .color(.textDefaultInfo), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultInfoActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultInfoHover))
        ])
        appearance.spinnerColor = StatefulFillStyle(defaultValue: .color(.textDefaultInfo), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultInfoActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultInfoHover))
        ])
        appearance.titleColor = StatefulFillStyle(defaultValue: .color(.textDefaultInfo), values: [
            .init(states: [InteractiveState.pressed], value: .color(.textDefaultInfoActive)),
            .init(states: [InteractiveState.hovered], value: .color(.textDefaultInfoHover))
        ])
        return appearance

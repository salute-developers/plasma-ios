...
public extension GeneralAppearanceVariation<SelectItemSingleTight, SelectItemAppearance, SelectItemSingleTightVariation.L> {
    
    var l: ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
        var size =  SelectItemSingleTightAnySize(size: appearance.size)
...
public extension GeneralAppearanceVariation<SelectItemSingleTight, SelectItemAppearance, SelectItemSingleTightVariation.M> {
    
    var m: ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
        var size =  SelectItemSingleTightAnySize(size: appearance.size)
        size.controlMargin = CGFloat(6.0)
        size.controlSize = CGFloat(24.0)
...
public extension GeneralAppearanceVariation<SelectItemSingleTight, SelectItemAppearance, SelectItemSingleTightVariation.S> {
    
    var s: ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
        var size =  SelectItemSingleTightAnySize(size: appearance.size)
        size.controlMargin = CGFloat(6.0)
        size.controlSize = CGFloat(24.0)
...
public extension GeneralAppearanceVariation<SelectItemSingleTight, SelectItemAppearance, SelectItemSingleTightVariation.Xl> {
    
    var xl: ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
        var size =  SelectItemSingleTightAnySize(size: appearance.size)
...
public extension GeneralAppearanceVariation<SelectItemSingleTight, SelectItemAppearance, SelectItemSingleTightVariation.Xs> {
    
    var xs: ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
        var size =  SelectItemSingleTightAnySize(size: appearance.size)
...
public extension ComponentAppearanceVariation<SelectItemSingleTight, SelectItemAppearance> {
    var variation: Variation<Appearance> {
        .init(
            originalVariation: self,
            styles: [

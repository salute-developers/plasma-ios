...
public struct SDDSCodeInput: View {
    ...
    public var body: some View {
        CoreInputView(
            ...
            inputMode: .input,
            valueColor: appearance.codeColor.resolvedDefaultValue(),
            valueColorError: appearance.codeColor.resolvedValue(for: Set([InteractiveState.error])),
            backgroundColor: .color(.clearColor),
            backgroundColorActivated: .color(.clearColor),
            backgroundColorError: .color(.clearColor),
            ...
            dotColor: .color(.clearColor),
            dotColorError: .color(.clearColor),
            ...
            strokeColor: appearance.strokeColor.resolvedDefaultValue(),
            strokeColorError: appearance.strokeColor.resolvedValue(for: Set([InteractiveState.error])),
            strokeColorFocused: appearance.strokeColor.resolvedDefaultValue(),
            fillColor: appearance.fillColor.resolvedDefaultValue(),
            fillColorError: appearance.fillColor.resolvedValue(for: Set([InteractiveState.error]), default: .color(.clearColor)),

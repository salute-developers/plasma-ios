...
| --- | --- | --- |
| Откуда состав свойств | `.sdds/ios-api-meta.json` — слепок `*Appearance` из `SDDSComponents` | хендмейд `*Props`/`*Appearance`/`*Size` на компонент в `SDDSThemeBuilderCore/Model/Components` |

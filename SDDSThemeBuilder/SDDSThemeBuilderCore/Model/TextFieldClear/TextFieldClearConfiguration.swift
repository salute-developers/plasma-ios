...
enum TextFieldClearVariationNode: String, Codable {
...
struct TextFieldClearProps: Codable {
    ...
    func merge(rhs: TextFieldClearProps) -> TextFieldClearProps {
        return TextFieldClearProps(
...
struct TextFieldClearVariation: Codable {
    let id: String
    let parent: String?
    let props: TextFieldClearProps
}

struct TextFieldClearConfiguration: Codable {
    ...
    let props: TextFieldClearProps
    let variations: [TextFieldClearVariation]
}

extension TextFieldClearConfiguration {
    var allProps: [String: TextFieldClearVariation] {
        var result = [String: TextFieldClearVariation]()
    ...
    func child(for key: SizeVariationKey, nodes: [TextFieldClearVariationNode]) -> TextFieldClearVariation? {
        return child(props: allProps, key: key, nodes: nodes)
    }
    
    func child(props: [String: TextFieldClearVariation], key: SizeVariationKey, nodes: [TextFieldClearVariationNode]) -> TextFieldClearVariation? {

...
enum TextAreaVariationNode: String, Codable {
...
struct TextAreaVariation: Codable {
    let id: String
    let parent: String?
    let props: TextAreaProps
}

struct TextAreaConfiguration: Codable {
    ...
    let props: TextAreaProps
    let variations: [TextAreaVariation]
}

extension TextAreaConfiguration {
    var allProps: [String: TextAreaVariation] {
        var result = [String: TextAreaVariation]()
    ...
    func child(for key: SizeVariationKey, nodes: [TextAreaVariationNode]) -> TextAreaVariation? {
        return child(props: allProps, key: key, nodes: nodes)
    }
    
    func child(props: [String: TextAreaVariation], key: SizeVariationKey, nodes: [TextAreaVariationNode]) -> TextAreaVariation? {

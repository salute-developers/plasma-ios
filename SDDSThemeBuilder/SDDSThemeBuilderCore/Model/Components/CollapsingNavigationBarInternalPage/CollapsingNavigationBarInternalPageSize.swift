...
struct CollapsingNavigationBarInternalPageSize: CodeGenerationSize {
    ...
    init(variation: CollapsingNavigationBarInternalPageConfiguration.Variation, nullify: Bool = false) {

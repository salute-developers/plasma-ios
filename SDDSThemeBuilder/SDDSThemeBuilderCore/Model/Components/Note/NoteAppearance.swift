...
struct NoteAppearance: CodeGenerationAppearance {
    ...
    init(variation: NoteConfiguration.Variation, component: CodeGenerationComponent) {
        self.init(props: variation.props, id: variation.id, component: component)
    }
    
    init(props: NoteProps?, id: String? = nil, component: CodeGenerationComponent) {

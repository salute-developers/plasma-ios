...
final class DownloadSchemeCommandTests: XCTestCase {
    /// SUT
    var downloadSchemeCommand: DownloadSchemeCommand!
    ...
    override func setUp() {
        ...
        let schemeURL = DownloadSchemeCommandTests.schemeURL
        let outputURL = URL(fileURLWithPath: NSTemporaryDirectory()).appendingPathComponent("scheme.json")
        
        downloadSchemeCommand = DownloadSchemeCommand(schemeURL: schemeURL, outputURL: outputURL, fileManager: fileManager)
    }

    func testDownloadSchemeCommand_Success_FromRemoteSource() {
        // given
    ...
    func testDownloadSchemeCommand_Success_FromLocalSource() {
        // given
        ...
        downloadSchemeCommand = DownloadSchemeCommand(schemeURL: localURL, outputURL: nil, fileManager: fileManager)
    ...
    func testDownloadSchemeCommand_Failure_InvalidURL() {
        // given
        let invalidURL = DownloadSchemeCommandTests.testURL
        
        downloadSchemeCommand = DownloadSchemeCommand(schemeURL: invalidURL, outputURL: nil, fileManager: fileManager)
...
extension DownloadSchemeCommandTests {

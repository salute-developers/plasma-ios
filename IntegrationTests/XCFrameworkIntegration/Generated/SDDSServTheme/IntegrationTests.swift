...
import SDDSIcons
@testable import IntegrationSDDSServTheme

/// Hosted-тесты: процесс — само приложение IntegrationSDDSServTheme. Падение на старте
...
final class IntegrationTests: XCTestCase {
    func testThemeInitializesAndExposesAppearance() {
        ...
        // шрифтов. Аппиранс из темы приходит из xcframework — height задан в SDDSServTheme.

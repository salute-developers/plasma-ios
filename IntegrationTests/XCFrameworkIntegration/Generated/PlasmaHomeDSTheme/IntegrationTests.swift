...
import SDDSIcons
@testable import IntegrationPlasmaHomeDSTheme

/// Hosted-тесты: процесс — само приложение IntegrationPlasmaHomeDSTheme. Падение на старте
...
final class IntegrationTests: XCTestCase {
    func testThemeInitializesAndExposesAppearance() {
        ...
        // шрифтов. Аппиранс из темы приходит из xcframework — height задан в PlasmaHomeDSTheme.

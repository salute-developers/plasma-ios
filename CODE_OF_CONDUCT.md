...
If the report concerns a maintainer, or you would rather not use a public channel, use GitHub's
[private vulnerability reporting](https://github.com/salute-developers/plasma-ios/security/advisories/new)
form — it is visible only to the maintainer team.
